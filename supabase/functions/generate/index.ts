...
async function generateFaceImages(
  ...
  userId: string
   ...
   const variations = [
    "large round doe-eyes positioned low on face, small delicate nose, full pouty lips, soft-round face, smooth chin, low-set hairline, SAME hair style and colour as described",
    "very large tall doe-eyes positioned low on face, small delicate nose, full tall lips with bare-pink tint, soft-round face, smooth chin, low-set hairline, SAME hair style and colour as described",
    "large bright almond-eyes positioned low on face, small delicate nose, full pouty lips, soft-round face, smooth chin, low-set hairline, SAME hair style and colour as described",
  ];

  const makeupVariations = [
    "light eyeshadow, mascara, thin eyeliner, subtle blush, natural makeup",
    "light eyeshadow, mascara, thin eyeliner, subtle blush, natural makeup",
    "soft eyeshadow, mascara, eyeliner, blush, polished makeup",
  ];

  const beautyCore = "extremely attractive young-woman, low-set hairline, feminine-soft features, soft-rounded jaw, small-rounded chin, slim face, small delicate nose, eyes positioned in centre of face, skin with visible pores, long styled hair past shoulders, plump full lips with soft-pink tint, mascara, eyeliner, eyeshadow, blush, confident closed-mouth smile";
