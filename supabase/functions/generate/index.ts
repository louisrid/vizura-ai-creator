...
serve(async (req) => {
  ...
  try {
    ...
    // Check credits using service role
    ...
    const negativePrompt = "low quality, blurry, distorted, ugly, deformed, disfigured, bad anatomy, watermark, text, signature";
    ...
    return new Response(JSON.stringify({ images: imageUrls, credits_remaining: creditData.balance - 1 }), {
