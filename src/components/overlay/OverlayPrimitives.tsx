...
export const ArrowButton = ({
  ...
  <button
    ...
    className="flex h-14 w-14 items-center justify-center rounded-2xl border-[4px] bg-black active:scale-[1.12] active:bg-[hsl(55,90%,58%)]"
    style={{ borderColor: "hsl(0 0% 100% / 0.15)", borderRadius: 16, transition: "transform 0.05s, background-color 0.05s" }}
  >
    {direction === "left" ? (
