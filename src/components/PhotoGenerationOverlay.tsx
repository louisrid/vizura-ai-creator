          ...
          <div className="relative z-10 flex w-full max-w-xs flex-col items-center gap-7">
            ...
            {resultImageUrl && (
              <motion.div
                ...
                className="rounded-2xl border-2 border-[#1a1a1a] overflow-hidden"
              >
            ...
            <motion.p
              className="text-center text-[15px] font-[900] lowercase"
              style={{ color: "rgba(255,255,255,0.4)" }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1, y: [0, -4, 0] }}
              transition={{ opacity: { duration: 0.3, delay: 0.7 }, y: { duration: 2.2, repeat: Infinity, ease: "easeInOut" } }}
            >
              tap to continue
            </motion.p>
          </div>
