      ...
      >
        <defs>
          <linearGradient id="header-top-bar-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="55%" style={{ stopColor: "hsl(var(--neon-yellow))", stopOpacity: 0.4 }} />
            <stop offset="75%" style={{ stopColor: "hsl(var(--neon-yellow))", stopOpacity: 0.15 }} />
            <stop offset="90%" style={{ stopColor: "hsl(var(--neon-yellow))", stopOpacity: 0.05 }} />
