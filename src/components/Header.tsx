...
const Header = () => {
  ...
  return (
    <header className="bg-nav sticky top-0 z-40 border-b-[2.5px] border-nav-foreground/15">
...
const CreditsBadge = () => {
  ...
  return (
    <div className="flex items-center gap-1.5 rounded-2xl border-[2.5px] border-nav-foreground/30 px-3 py-1.5">
