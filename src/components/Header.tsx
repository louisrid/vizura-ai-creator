...
const Header = () => {
  ...
  const headerContainerClass = "mx-auto flex w-full max-w-lg items-center justify-between px-[20px] py-[18px] md:max-w-3xl md:px-[36px] md:py-[22px] min-h-[78px] md:min-h-[90px]";
