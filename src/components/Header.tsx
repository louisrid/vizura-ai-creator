        ...
        >
          <div>
            ...
            >
              ...
              {user && (
                <>
                  <div style={{ height: 2, backgroundColor: "hsl(var(--border-dark))", margin: "0" }} />
                  <button
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative">
          <div className="w-full mx-auto flex items-center justify-between pl-[22px] pr-[14px] md:px-8 lg:px-12 pt-[40px] md:pt-[52px] pb-3">
