...
const CreditsBadge = () => {
  ...
  return (
    <div className="flex items-center gap-1.5 rounded-2xl <div className="flex items-center gap-1.5 rounded-2xl border-gradient-yellow px-3 py-1.5"> px-3 py-1.5">
