...
const Header = () => {
  ...
  const headerContainerClass = "mx-auto flex w-full max-w-lg items-center justify-between px-[20px] py-[14px] md:max-w-3xl md:px-[36px] md:py-[18px] min-h-[72px] md:min-h-[84px]";
