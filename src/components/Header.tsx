...
const Header = () => {
  ...
  const headerContainerClass = "mx-auto flex w-full max-w-lg items-center justify-between px-[20px] pt-[14px] pb-[22px] md:max-w-3xl md:px-[36px] md:pt-[18px] md:pb-[26px] min-h-[78px] md:min-h-[90px]";
