...
const Header = () => {
  ...
  return (
    <header className="bg-nav sticky top-0 z-40 border-b-[2.5px] border-nav-foreground/15"> className="bg-nav sticky top-0 z-40 border-b-[2.5px] border-nav-foreground/15"> className="bg-nav sticky top-0 z-40 border-b-[2.5px] border-nav-foreground/15">">
        ...
        <div className="relative flex items-center gap-3" ref={menuRef}>
          ...
          {user && (
            <button onClick={() => navigate("/account")} className="shrink-0">
              <UserRound size={14} strokeWidth={2} fill="currentColor" stroke="currentColor" className="text-nav-foreground" />
            </button>
          )}
...
const CreditsBadge = () => {
  ...
  return (
    <div className="flex items-center gap-1.5 rounded-2xl border-[2.5px] border-nav-foreground/30 px-3 py-1.5"> className="flex items-center gap-1.5 rounded-2xl border-[2.5px] border-nav-foreground/30 px-3 py-1.5"> className="flex items-center gap-1.5 rounded-2xl border-[2.5px] border-nav-foreground/30 px-3 py-1.5">">
