...
const Header = () => {
  ...
  return (
    <header className="bg-nav sticky top-0 z-40 border-b-[3.5px] border-nav-foreground/15">
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="absolute right-0 top-full mt-2 mr-0 w-48 bg-nav border-[3.5px] border-nav-foreground/20 rounded-2xl shadow-medium overflow-hidden"
              >
...
const CreditsBadge = () => {
  ...
  return (
    <div className="flex items-center gap-1.5 rounded-2xl border-[3.5px] border-nav-foreground/30 px-3 py-1.5">
