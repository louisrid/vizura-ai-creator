...
const Header = () => {
  ...
  const headerContainerClass = "mx-auto flex w-full max-w-lg items-center justify-between px-[20px] pt-[24px] pb-[18px] md:max-w-3xl md:px-[36px] md:pt-[28px] md:pb-[20px] min-h-[80px] md:min-h-[92px]";
