...
const Header = () => {
  ...
  const headerContainerClass = "mx-auto flex h-[73px] w-full max-w-lg items-center justify-between px-[20px] md:h-[100px] md:max-w-3xl md:px-[36px]";

  return (
    <header className="sticky top-0" style={{ zIndex: 9990, backgroundColor: "#000000", borderBottom: "3px solid #ffe603", paddingTop: "3px", paddingBottom: "3px" }}>
