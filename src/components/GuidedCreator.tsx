  ...
  const renderSlide = () => {
    ...
    if (isSet1Slide1) {
      ...
      return (
        <div className="flex w-full flex-col items-center">
          <span className="text-[42px] md:text-[58px] inline-block leading-none" style={{ marginBottom: 2, animation: "emoji-bounce 1.6s ease-in-out infinite", transform: "translateY(18%)" }}>
            {slide.emoji}
          </span>
    ...
    if (isNameSlide) return (
      <div className="flex w-full flex-col items-center" onClick={(e) => e.stopPropagation()}>
        <span className="text-[42px] md:text-[58px] inline-block leading-none" style={{ marginBottom: 2, animation: "emoji-bounce 1.6s ease-in-out infinite", transform: "translateY(18%)" }}>✨</span>
    ...
    if (currentTraitIndex >= 0) {
      ...
      return (
        <div className="flex w-full flex-col items-center">
            <span className="text-[42px] md:text-[58px] inline-block leading-none" style={{ marginBottom: 2, animation: "emoji-bounce 1.6s ease-in-out infinite", transform: "translateY(18%)" }}>{trait.emoji}</span>
    ...
    if (isCreateSlide) {
      ...
      return (
        <div className="flex w-full flex-col items-center">
          <span className="text-[42px] md:text-[58px] inline-block leading-none" style={{ marginBottom: 2, animation: "emoji-bounce 1.6s ease-in-out infinite", transform: "translateY(18%)" }}>🖌️</span>
