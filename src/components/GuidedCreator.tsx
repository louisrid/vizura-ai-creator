...
const NavArrow = ({ direction, onClick, disabled, colorOverride }: { direction: "left" | "right"; onClick: () => void; disabled?: boolean; colorOverride?: string }) => {
    ...
    const fillColor = colorOverride || "hsl(var(--neon-yellow))";
    ...
    return (
      <button
        ...
        style={{
          ...
          border: isForward ? "none" : `2.5px solid ${fillColor}`,
...
const InteractivePill = ({ label, selected, shaking, onClick }: {
  ...
  <motion.button
    ...
    style={{
      ...
      ...(selected
        ? { backgroundColor: Y, color: "#000000", border: `2.5px solid ${Y}` }
        : { backgroundColor: "hsl(var(--card))", color: "#ffffff", border: "2.5px solid hsl(var(--border-mid))" }
      ),
    }}
  >
  ...
  return (
    <div className="flex min-h-full w-full flex-col items-center justify-center">
      <div className="flex flex-col items-center px-8 w-full max-w-md">
        ...
        <div className="mt-8 w-full rounded-[3px] border-[2.5px] border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
          <button
          ...
          <input
            ...
            style={{ borderRadius: 3, border: "2.5px solid hsl(var(--border-mid))", backgroundColor: "hsl(var(--card))" }}
            disabled={googleLoading}
          />
          <input
          ...
          <button
            ...
            style={{ borderRadius: 3, background: 'hsl(var(--neon-yellow))', color: '#000000' }}
          >
...
const GuidedCreator = forwardRef<HTMLDivElement, GuidedCreatorProps>(({ open, onComplete, onExit, skipWelcome = false }, _ref) => {
  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', paddingTop: '2vh', paddingBottom: '2vh' }}>
        <div style={{ position: 'relative', width: 298, height: 298, display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: 0, marginBottom: 8 }}>
          {[
        ...
        <div className="font-display" style={{ fontSize: 88, color: '#ffffff', lineHeight: 1, marginTop: 16, marginBottom: 6, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }}>facebox</div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }}>
          ...
          {(
            ...
            }} style={{ width: 204, padding: '8px 0', fontSize: 32, fontWeight: 900, background: '#000000', border: '2.5px solid hsl(var(--neon-yellow))', borderRadius: 3, color: '#ffffff', textTransform: 'lowercase', cursor: 'pointer', letterSpacing: '-0.02em' }}>login</button>
          )}
        </div>
      </div>
    );
      ...
      return (
        <div className="flex w-full flex-col items-center">
          ...
          <button
            ...
            style={{ backgroundColor: "#050a10", color: "#ffffff", borderRadius: 3, border: "2.5px solid #00e0ff" }}
          >
    ...
    <div className="fixed inset-0 z-[9999]" style={{ backgroundColor: "#000000" }}>
      ...
      >
        <div className="relative z-10 flex flex-col items-center px-8 w-full max-w-md">
          ...
          <div className="mt-8 w-full rounded-[3px] border-[2.5px] border-[hsl(0_0%_12%)] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
            <button
