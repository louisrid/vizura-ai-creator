  ...
  return (
    <div className="flex min-h-full w-full flex-col items-center justify-center">
      <div className="flex flex-col items-center px-8 w-full max-w-md">
        ...
        <div className="mt-8 w-full rounded-[4px] border-2 border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
          <button
            ...
            style={{ background: Y, color: "#000000", borderRadius: 4, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "none" }}
          >
          ...
          <input
            ...
            style={{ borderRadius: 4, border: "2px solid hsl(var(--border-mid))", backgroundColor: "hsl(var(--card))" }}
            disabled={googleLoading}
          />
          <input
          ...
          <button
            ...
            style={{ borderRadius: 4, background: '#ffe603', color: '#000000' }}
          >
  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', paddingTop: '6vh', paddingBottom: '2vh' }}>
        ...
        <div style={{ width: 204, height: 16, background: '#ffe603', borderRadius: 4, marginTop: 6, marginBottom: 28, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }} />
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }}>
          <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); advance(); }} style={{ width: 204, padding: '10px 0', fontSize: 32, fontWeight: 900, background: '#ffe603', border: 'none', borderRadius: 4, color: '#000000', textTransform: 'lowercase', cursor: 'pointer', letterSpacing: '-0.02em' }}>start</button>
          {(
            ...
            }} style={{ width: 204, padding: '8px 0', fontSize: 32, fontWeight: 900, background: '#000000', border: '2px solid #ffe603', borderRadius: 4, color: '#ffffff', textTransform: 'lowercase', cursor: 'pointer', letterSpacing: '-0.02em' }}>login</button>
          )}
        </div>
      </div>
    );
      ...
      <div className="flex w-full flex-col items-center" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mt-5 md:mt-7 flex items-center gap-2.5 w-full max-w-[17rem] md:max-w-[22rem]">
          ...
          <motion.button
            ...
            style={{ borderRadius: 4, backgroundColor: Y }}
          >
      ...
      return (
        <div className="flex w-full flex-col items-center">
          ...
          <button
            ...
            style={{ backgroundColor: "#050a10", color: "#ffffff", borderRadius: 4, border: "2px solid #00e0ff" }}
          >
    ...
    <div className="fixed inset-0 z-[9999]" style={{ backgroundColor: "#000000" }}>
      ...
      >
        <div className="relative z-10 flex flex-col items-center px-8 w-full max-w-md">
          ...
          <div className="mt-8 w-full rounded-[4px] border-2 border-[hsl(0_0%_12%)] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
            <button
