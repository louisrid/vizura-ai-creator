  ...
  return (
    <div className="flex min-h-full w-full flex-col items-center justify-center">
      <div className="flex flex-col items-center px-8 w-full max-w-md">
        ...
        <div className="mt-8 w-full rounded-[7px] border-2 border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
          <button
            ...
            style={{ background: Y, color: "#000000", borderRadius: 7, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "none" }}
          >
          ...
          <input
            ...
            style={{ borderRadius: 7, border: "2px solid hsl(var(--border-mid))", backgroundColor: "hsl(var(--card))" }}
            disabled={googleLoading}
          />
          <input
          ...
          <button
            ...
            style={{ borderRadius: 7, background: '#ffe603', color: '#000000' }}
          >
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.3s ease' }}>
          <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); advance(); }} style={{ width: 240, padding: '12px 0', fontSize: 30, fontWeight: 900, background: '#ffe603', border: 'none', borderRadius: 7, color: '#000000', textTransform: 'lowercase', cursor: 'pointer', letterSpacing: '-0.02em' }}>start</button>
          {(
            ...
            }} style={{ width: 240, padding: '10px 0', fontSize: 30, fontWeight: 900, background: '#000000', border: '2px solid #ffe603', borderRadius: 7, color: '#ffffff', textTransform: 'lowercase', cursor: 'pointer', letterSpacing: '-0.02em' }}>login</button>
          )}
        </div>
      </div>
    );
          ...
          <div ref={contentInnerRef} style={{ transform: `scale(${contentScale})`, transformOrigin: "top center" }}>
            <div className="flex items-center gap-2.5 w-full max-w-[17rem] md:max-w-[22rem] mx-auto">
              ...
              <motion.button
                ...
                style={{ borderRadius: 7, backgroundColor: Y }}
              >
          ...
          <div ref={contentSlotRef} className="w-full" style={{ marginTop: SLIDE_CONTENT_GAP, height: contentHeight }}>
            <div ref={contentInnerRef} style={{ transform: `scale(${contentScale})`, transformOrigin: "top center" }}>
              <button
                ...
                style={{ backgroundColor: "#050a10", color: "#ffffff", borderRadius: 7, border: "2px solid #00e0ff" }}
              >
    ...
    >
      ...
      <div className="flex-1 flex justify-center px-6 md:px-12 min-h-0 overflow-hidden">
        <div
          ...
          style={visualStepType !== "hero" ? { paddingTop: 168, paddingBottom: 0 } : undefined}
        >
