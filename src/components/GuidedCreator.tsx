...
const GuidedCreator = forwardRef<HTMLDivElement, GuidedCreatorProps>(({ open, onComplete, onExit, skipWelcome = false }, _ref) => {
  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', position: 'relative', transform: 'translateY(-80px)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, fontSize: 94, fontFamily: "'Roundo', sans-serif", fontWeight: 400, color: '#ffffff', letterSpacing: '-0.03em', lineHeight: 1, marginTop: 0, marginBottom: 24 }}>facebox</div>
