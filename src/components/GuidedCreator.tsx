  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', paddingBottom: '2vh' }}>
        ...
        <div style={{ width: 204, height: 13, background: '#ffe603', <div style={{ width: 204, height: 13, background: '#ffe603', borderRadius: 9999, marginTop: 6, marginBottom: 28, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }} />, marginBottom: 28, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }} />
