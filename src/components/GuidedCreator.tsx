    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', paddingTop: '6vh', paddingBottom: '2vh' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }}>
          <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); advance(); }} style={{ width: 204, padding: '10px 0', fontSize: 32, fontWeight: 900, background: '#ffe603', border: 'none', borderRadius: 6, color: '#000000', textTransform: 'lowercase', cursor: 'pointer', letterSpacing: '-0.02em' }}>start</button>
          {(
            ...
            }} style={{ width: 204, padding: '8px 0', fontSize: 32, fontWeight: 900, background: '#000000', border: '2px solid #ffe603', borderRadius: 6, color: '#ffffff', textTransform: 'lowercase', cursor: 'pointer', letterSpacing: '-0.02em' }}>login</button>
          )}
        </div>
      </div>
    );
    ...
    <div className="fixed inset-0 z-[9999]" style={{ backgroundColor: "#000000" }}>
      ...
      >
        <div className="relative z-10 flex flex-col items-center px-8 w-full max-w-md">
          ...
          <div className="mt-8 w-full rounded-[6px] border-2 border-[hsl(0_0%_12%)] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
            <button
