  ...
  <motion.button
    ...
    style={{
      ...
      ...(selected
        ...
        : { backgroundColor: "hsl(var(--card))", color: "#ffffff", border: "1px solid hsl(var(--border-mid))" }
      ),
    }}
  >
      ...
      <div className="flex flex-col items-center px-8 w-full max-w-md">
        ...
        <div className="mt-8 w-full rounded-[8px] border-[1px] border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
          ...
          <input
            ...
            style={{ borderRadius: 8, border: "1px solid hsl(var(--border-mid))", backgroundColor: "hsl(var(--card))" }}
            disabled={googleLoading}
          />
          <input
