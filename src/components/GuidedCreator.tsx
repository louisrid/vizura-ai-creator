  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', paddingTop: '6vh', paddingBottom: '2vh' }}>
        <div style={{ position: 'relative', width: 298, height: 298, display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: -40, marginBottom: 8 }}>
          {[
        ...
        <div className="font-display" style={{ fontSize: 88, color: '#ffffff', lineHeight: 1, marginTop: 10, marginBottom: 12, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }}>facebox</div>
