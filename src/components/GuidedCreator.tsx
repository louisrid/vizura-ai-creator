  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', position: 'relative' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, fontSize: 96, fontFamily: "'Roundo', sans-serif", fontWeight: 400, color: '#ffffff', letterSpacing: '-0.03em', lineHeight: 1, marginTop: 4, marginBottom: 24 }}>facebox</div>
