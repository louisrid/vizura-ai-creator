...
const GuidedCreator = forwardRef<HTMLDivElement, GuidedCreatorProps>(({ open, onComplete, onExit, skipWelcome = false }, _ref) => {
  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', paddingTop: '0', paddingBottom: '22vh' }}>
        ...
        <div className="font-display" style={{ fontSize: 76, color: '#ffffff', lineHeight: 1, marginTop: 4, marginBottom: 34, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }}>facebox</div>
