  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%' }}>
        ...
        <div style={{ width: 171, height: 10, background: '#ffe603', borderRadius: 0, marginTop: 8, marginBottom: 20, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }} />, height: 10, background: '#ffe603', borderRadius: 0, marginTop: 8, marginBottom: 20, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }} /> marginTop: 8, marginBottom: 20, opacity: heroPhase >= 3 ? 1 : 0, transition: 'opacity 0.9s ease' }} />
