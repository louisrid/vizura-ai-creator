  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', position: 'relative' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, fontSize: 116, fontWeight: 900, color: '#ffffff', letterSpacing: '-0.03em', lineHeight: 1, marginTop: 4, marginBottom: 24 }}>facebox</div>
    ...
    >
      ...
      <div className="flex-1 flex justify-center px-6 md:px-12 min-h-0 overflow-hidden">
        <div
          ...
          style={visualStepType === "hero" || visualStepType === "signup" ? undefined : { paddingTop: 64, paddingBottom: 0 }}
        >
          {isHeroSlide ? (
