  ...
  <motion.button
    ...
    style={{
      ...
      ...(selected
        ...
        : { backgroundColor: "hsl(var(--card))", color: "#ffffff", border: "2.25px solid hsl(var(--border-mid))" }
      ),
    }}
  >
  ...
  return (
    <div className="flex min-h-full w-full flex-col items-center justify-center">
      <div className="flex flex-col items-center px-8 w-full max-w-md">
        ...
        <div className="mt-8 w-full rounded-[8px] border-[2.25px] border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
          <button
          ...
          <input
            ...
            style={{ borderRadius: 8, border: "2.25px solid hsl(var(--border-mid))", backgroundColor: "hsl(var(--card))" }}
            disabled={googleLoading}
          />
          <input
