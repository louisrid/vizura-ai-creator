  ...
  <motion.button
    ...
    style={{
      ...
      ...(selected
        ...
        : { backgroundColor: "hsl(var(--card))", color: "#ffffff", border: "1.75px solid hsl(var(--border-mid))" }
      ),
    }}
  >
  ...
  return (
    <div className="flex min-h-full w-full flex-col items-center justify-center">
      <div className="flex flex-col items-center px-8 w-full max-w-md">
        ...
        <div className="mt-8 w-full rounded-[8px] border-[1.75px] border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
          <button
          ...
          <input
            ...
            style={{ borderRadius: 8, border: "1.75px solid hsl(var(--border-mid))", backgroundColor: "hsl(var(--card))" }}
            disabled={googleLoading}
          />
          <input
  ...
  const renderHero = () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: '100%', position: 'relative' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, fontSize: 116, fontWeight: 900, color: '#ffffff', letterSpacing: '-0.03em', lineHeight: 1, marginTop: 4, marginBottom: 38 }}>facebox</div>
