  ...
  return (
    <div className="flex min-h-full w-full flex-col items-center justify-center">
      <div className="flex flex-col items-center px-8 w-full max-w-md">
        <motion.span
          className="text-[64px] md:text-[86px] mb-7 md:mb-9 inline-block"
          animate={{ y: [0, -12, 0] }}
...
<motion.span className="text-[64px] md:text-[86px] mb-7 md:mb-9 inline-block" animate={{ y: [0, -12, 0] }} transition={{ duration: 1.6, repeat: Infinity, ease: "easeInOut" }}>
            {slide.emoji}
          </motion.span>
    ...
    if (isNameSlide) return (
      <div className="flex w-full flex-col items-center" onClick={(e) => e.stopPropagation()}>
        <motion.span className="text-[64px] md:text-[86px] mb-7 md:mb-9 inline-block" animate={{ y: [0, -12, 0] }} transition={{ duration: 1.6, repeat: Infinity, ease: "easeInOut" }}>✨</motion.span>
    ...
    if (currentTraitIndex >= 0) {
      ...
      return (
        <div className="flex w-full flex-col items-center">
          <motion.span className="text-[64px] md:text-[86px] mb-7 md:mb-9 inline-block" animate={{ y: [0, -12, 0] }} transition={{ duration: 1.6, repeat: Infinity, ease: "easeInOut" }}>{trait.emoji}</motion.span>
  ...
  return createPortal(
    ...
    >
      ...
      <div className="absolute inset-0 flex items-start justify-center px-6 md:px-12">
        <div className={`mx-auto flex w-full ${isSignupScreen ? "max-w-md md:max-w-lg" : "max-w-sm md:max-w-lg"} ${isHeroSlide || isSignupScreen ? "items-center justify-center min-h-full" : "items-start pt-[23vh] pb-[190px]"} justify-center`}>
