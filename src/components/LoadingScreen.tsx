  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ width: "14rem", height: 8, overflow: "hidden", background: "rgba(255,255,255,0.1)", borderRadius: 1, position: "relative" }}>
          <div
            style={{
              width: "40%",
              height: "100%",
              background: "#eaeaea",
              borderRadius: 1,
              boxShadow: "0 0 10px #eaeaea, 0 0 20px rgba(234, 234, 234,0.25)",
