...
const hairStyleOptions = ["long straight", "wavy", "fringe/bangs"] as const;
...
const CharacterCreator = () => {
  ...
  return (
    <div className={`relative min-h-screen ${pageHidden ? "bg-black" : "bg-background"}`}>
      ...
      {!pageHidden && (
      <main className="mx-auto flex w-full max-w-lg md:max-w-3xl flex-col px-4 md:px-10 pt-1 pb-[250px]">
