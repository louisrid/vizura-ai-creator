      ...
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[32px] pt-[44px] pb-[280px]">
        ...
        <div className="flex flex-col gap-5">
          ...
          <AnimatePresence>
            {claimChecked && canClaimFree && (
              <motion.div
                ...
                className="relative rounded-[7px] overflow-hidden p-5"
                style={{
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    ...
                    <button
                      ...
                      disabled={claiming}
                      className="flex items-center gap-2 rounded-[7px] px-5 py-3 text-sm font-[900] lowercase transition-all disabled:opacity-60"
          ...
          {packs.map((pack) => (
            <div
              key={pack.id}
              className="relative rounded-[7px] overflow-hidden p-5 flex gap-4"
              style={{
            ...
            >
              ...
              <div className="flex-1 flex flex-col relative z-[1]">
                ...
                {pack.badge && (
                  <div className="mt-2">
                    <span className="inline-block rounded-[7px] px-3 py-1 text-[10px] font-[900] lowercase bg-neon-yellow text-neon-yellow-foreground">
                      {pack.badge}
                    </span>
                  </div>
                )}
                ...
                <div className="mt-auto pt-2">
                  <span
                    className="inline-flex items-center gap-1.5 rounded-[7px] px-3.5 py-1.5 text-[13px] font-[900] lowercase text-white"
              ...
              >
                ...
                <span
                  className="cart-btn rounded-[7px] px-5 py-3 bg-neon-yellow text-neon-yellow-foreground flex items-center justify-center"
                >
