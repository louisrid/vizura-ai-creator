              ...
              <div className="mx-auto mt-2 flex w-full max-w-[26rem] md:max-w-[40rem] flex-col gap-4 md:gap-6">
                <div className="grid grid-cols-3 gap-3 md:gap-6">
                  {faces.map((url, i) => (
                    ...
                    <motion.button
                        ...
                        style={{
                          borderRadius: 1,
                          border: selectedIndex === i ? "3px solid #eaeaea" : "3px solid transparent",
                          overflow: "hidden",
                        }}
                      >
                ...
                <div className="flex flex-col gap-2.5 md:gap-3 mt-2">
                  <button
                    ...
                    style={{
                      borderRadius: 1,
                      backgroundColor: selectedIndex !== null ? "#eaeaea" : "hsl(var(--card))",
                ...
                {(() => {
                  try {
                    ...
                    return (
                      <div className="mt-4 md:mt-6 px-4 py-3" style={{ backgroundColor: "hsl(var(--card))", borderRadius: 1 }}>
                        <div className="grid grid-cols-4 gap-1.5">
                          {traitItems.map((t) => (
                            <div key={t.label} className="rounded-[1px] py-2 text-center" style={{ backgroundColor: "hsl(var(--card))" }}>
                              ...
                              <span className={`inline-block font-[800] text-white leading-none text-[11px] border-[2px] border-[hsl(var(--border-mid))] rounded-[1px] ${t.value === "XL" ? "normal-case" : "lowercase"}`} style={{ backgroundColor: "#000000", padding: "6px 12px" }}>{t.value}</span>
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            <div className="mt-16 flex flex-col items-center gap-4">
              ...
              {generationError && (
                <button
                  ...
                  style={{ backgroundColor: "#eaeaea", color: "#000000", borderRadius: 1 }}
                >
                  try again
                </button>
              )}
