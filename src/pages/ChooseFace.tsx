              ...
              <div className="mx-auto mt-2 flex w-full max-w-[26rem] md:max-w-[40rem] flex-col gap-4 md:gap-6">
                ...
                {(() => {
                  try {
                    ...
                    return (
                      <div className="mt-4 md:mt-6 px-4 py-3" style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }}>
                        <div className="grid grid-cols-4 gap-1.5">
                          {traitItems.map((t) => (
                            <div key={t.label} className="rounded-[5px] py-2 text-center" style={{ backgroundColor: "hsl(var(--card))" }}>
                              ...
                              <span className={`inline-block font-[800] text-white leading-none text-[11px] border-[2px] border-[hsl(var(--border-mid))] rounded-[5px] ${t.value === "XL" ? "normal-case" : "lowercase"}`} style={{ backgroundColor: "hsl(var(--card))", padding: "6px 12px" }}>{t.value}</span>
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            <div className="mt-16 flex flex-col items-center gap-4">
              ...
              {generationError && (
                <button
                  ...
                  style={{ backgroundColor: "#ffe603", color: "#000000", borderRadius: 5 }}
                >
                  try again
                </button>
              )}
