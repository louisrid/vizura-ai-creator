            ...
            <main className="relative z-[1] mx-auto flex w-full max-w-lg flex-col overflow-y-auto px-[14px] pt-10 pb-[280px] md:max-w-3xl md:px-10">
              <div className="flex items-center gap-3 mb-5">
                <button
                  ...
                  aria-label="go back"
                >
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="#ffe603" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="md:w-[16px] md:h-[16px]">
            ...
            <div className="mt-16 flex flex-col items-center gap-4">
              ...
              {generationError && (
                <button
                  ...
                  style={{ backgroundColor: "#000000", color: "#ffe603", border: "2px solid #ffe603", borderRadius: 10 }}
                >
                  try again
                </button>
              )}
