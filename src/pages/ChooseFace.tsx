              ...
              <div className="mx-auto mt-2 flex w-full max-w-[26rem] md:max-w-[40rem] flex-col gap-4 md:gap-6">
                <div className="grid grid-cols-3 gap-3 md:gap-6">
                  {faces.map((url, i) => (
                    ...
                    <motion.button
                        ...
                        style={{
                          borderRadius: 2,
                          border: selectedIndex === i ? "3px solid #cbc5c0" : "3px solid transparent",
                          overflow: "hidden",
                        }}
                      >
                ...
                <div className="flex flex-col gap-2.5 md:gap-3 mt-2">
                  <button
                    ...
                    style={{
                      borderRadius: 2,
                      backgroundColor: selectedIndex !== null ? "#cbc5c0" : "hsl(var(--card))",
            ...
            <div className="mt-16 flex flex-col items-center gap-4">
              ...
              {generationError && (
                <button
                  ...
                  style={{ backgroundColor: "#cbc5c0", color: "#000000", borderRadius: 2 }}
                >
                  try again
                </button>
              )}
