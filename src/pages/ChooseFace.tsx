      ...
      {/* Face picker — shown after loading completes */}
        {!loading && faces.length > 0 && (
          <>
            ...
            <main className="relative z-[1] mx-auto flex w-full max-w-lg flex-col overflow-y-auto px-[14px] pt-1 pb-[140px] md:max-w-3xl md:px-10">
              ...
              <div className="mx-auto mt-2 flex w-full max-w-[26rem] md:max-w-[40rem] flex-col gap-4 md:gap-6">
                ...
                <div className="flex flex-col gap-2.5 md:gap-3 mt-2">
                  <button
                    ...
                    style={{
                      borderRadius: 12,
                      backgroundColor: selectedIndex !== null ? "#facc15" : "#1e1e1e",
