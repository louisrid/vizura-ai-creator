                ...
                <div className="grid grid-cols-3 gap-3 md:gap-6">
                  {faces.map((url, i) => (
                    ...
                    <motion.button
                        ...
                        style={{
                          borderRadius: 8,
                          border: selectedIndex === i ? "1.5px solid #ffe603" : "1.5px solid transparent",
                          overflow: "hidden",
                        }}
                      >
                        ...
                        <div className="grid grid-cols-4 gap-1.5">
                          {traitItems.map((t) => (
                            <div key={t.label} className="rounded-[8px] py-2 text-center" style={{ backgroundColor: "hsl(var(--card))" }}>
                              ...
                              <span className={`inline-block font-[800] text-white leading-none text-[11px] border-[1.5px] border-[hsl(var(--border-mid))] rounded-[8px] ${t.value === "XL" ? "normal-case" : "lowercase"}`} style={{ backgroundColor: "hsl(var(--card))", padding: "6px 12px" }}>{t.value}</span>
                            </div>
                          ))}
                        </div>
                      </div>
