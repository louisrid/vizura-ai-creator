  ...
  return (
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-[64px] pb-[280px] md:hidden">
          {/* Hero */}
          <h1 className="text-[50px] font-[900] lowercase leading-[0.94] tracking-[-2px] text-white mb-0">
            what are we making today?{/* ✨ */}
          </h1>
          <div className="mt-5 mb-6" style={{ width: 60, height: 8, borderRadius: 2, backgroundColor: "#eaeaea" }} />
            ...
            <div className="grid grid-cols-4 gap-2">
              {!photosLoaded && images.length === 0 ? (
                Array.from({ length: 4 }).map((_, i) => (
                  <div key={`skel-p-${i}`} style={{ borderRadius: 2, overflow: "hidden", backgroundColor: "hsl(0 0% 5%)" }}>
          ...
          <section className="mt-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              {!charsLoaded && characters.length === 0 ? (
                Array.from({ length: 4 }).map((_, i) => (
                  <div key={`skel-c-${i}`} style={{ borderRadius: 2, overflow: "hidden", backgroundColor: "hsl(0 0% 5%)" }}>
                    <AspectRatio ratio={3 / 4}>
                      <div className="h-full w-full" style={{ backgroundColor: "hsl(0 0% 5%)" }} />
                    </AspectRatio>
                  </div>
        ...
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-10 pt-[64px] pb-[280px]">
          ...
          <div className="mt-6 mb-10" style={{ width: 60, height: 8, borderRadius: 2, backgroundColor: "#eaeaea" }} />
