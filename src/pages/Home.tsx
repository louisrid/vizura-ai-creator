    ...
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-8 pb-[280px] md:hidden">
          ...
          <div className="mt-5 mb-6" style={{ width: 60, height: 8, borderRadius: 2, backgroundColor: "#cbc5c0" }} />
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 2 }}>
                <button
                  ...
                  style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #cbc5c0", borderRadius: 2 }}
                >
                  see all →
                </button>
          ...
          <section className="mt-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 2 }}>
                <button onClick={() => { if (!onboardingComplete) return; navigate("/characters"); }} className="text-[11px] font-[800] lowercase px-3 py-1.5 transition-transform" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #cbc5c0", borderRadius: 2 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={4} />}
              </div>
        ...
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-10 pt-8 pb-[280px]">
          ...
          <div className="mt-6 mb-10" style={{ width: 60, height: 8, borderRadius: 2, backgroundColor: "#cbc5c0" }} />
          ...
          <section className="mt-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 2 }}>
                <button onClick={() => { if (!onboardingComplete) return; navigate("/characters"); }} className="text-[13px] font-[800] lowercase px-4 py-2 transition-transform hover-glow" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #cbc5c0", borderRadius: 2 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={4} />}
              </div>
