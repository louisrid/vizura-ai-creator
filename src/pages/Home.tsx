    ...
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-8 pb-[280px] md:hidden">
          ...
          <div className="mt-3 mb-6" style={{ width: 60, height: 8, borderRadius: 9999, background: "linear-gradient(135deg, #d4b8ff, #c4a0ff)" }} />
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 10 }}>
                <button
                  ...
                  style={{ color: "#c4a0ff", backgroundColor: "#000000", border: "2px solid #c4a0ff", borderRadius: 10 }}
                >
                  see all →
                </button>
          ...
          <section className="mt-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 10 }}>
                <button onClick={() => { if (!onboardingComplete) return; navigate("/characters"); }} className="text-[11px] font-[800] lowercase px-3 py-1.5 transition-transform" style={{ color: "#c4a0ff", backgroundColor: "#000000", border: "2px solid #c4a0ff", borderRadius: 10 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={10} />}
              </div>
        ...
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-10 pt-8 pb-[280px]">
          ...
          <div className="mt-4 mb-10" style={{ width: 60, height: 8, borderRadius: 9999, background: "linear-gradient(135deg, #d4b8ff, #c4a0ff)" }} />
          ...
          <section className="mt-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 10 }}>
                <button onClick={() => { if (!onboardingComplete) return; navigate("/characters"); }} className="text-[13px] font-[800] lowercase px-4 py-2 transition-transform hover-glow" style={{ color: "#c4a0ff", backgroundColor: "#000000", border: "2px solid #c4a0ff", borderRadius: 10 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={10} />}
              </div>
