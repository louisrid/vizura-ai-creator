    ...
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-14 pb-[280px] md:hidden">
          ...
          <div className="mt-5 mb-6" style={{ width: 60, height: 8, borderRadius: 1, backgroundColor: "#eaeaea" }} />
          ...
          <section className="mb-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 1 }}>
                <button
                  ...
                  style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #eaeaea", borderRadius: 1 }}
                >
                  see all →
                </button>
            ...
            <div className="grid grid-cols-4 gap-2">
              {!photosLoaded && images.length === 0 ? (
                Array.from({ length: 4 }).map((_, i) => (
                  <div key={`skel-p-${i}`} style={{ borderRadius: 1, overflow: "hidden", backgroundColor: "hsl(0 0% 5%)" }}>
          ...
          <section className="mt-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 1 }}>
                <button onClick={() => { if (!onboardingComplete) return; navigate("/characters"); }} className="text-[11px] font-[800] lowercase px-3 py-1.5 transition-transform" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #eaeaea", borderRadius: 1 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={4} />}
              </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {!charsLoaded && characters.length === 0 ? (
                Array.from({ length: 4 }).map((_, i) => (
                  <div key={`skel-c-${i}`} style={{ borderRadius: 1, overflow: "hidden", backgroundColor: "hsl(0 0% 5%)" }}>
                    <AspectRatio ratio={3 / 4}>
                      <div className="h-full w-full" style={{ backgroundColor: "hsl(0 0% 5%)" }} />
                    </AspectRatio>
                  </div>
        ...
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-10 pt-14 pb-[280px]">
          ...
          <div className="mt-6 mb-10" style={{ width: 60, height: 8, borderRadius: 1, backgroundColor: "#eaeaea" }} />
          ...
          <section className="mt-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 1 }}>
                <button onClick={() => { if (!onboardingComplete) return; navigate("/characters"); }} className="text-[13px] font-[800] lowercase px-4 py-2 transition-transform hover-glow" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #eaeaea", borderRadius: 1 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={4} />}
              </div>
          ...
          <div className="p-3 md:p-4 space-y-2" style={{ backgroundColor: "hsl(var(--card))", borderRadius: "0 0 2px 2px" }}>
            {selectedImage.prompt && selectedImage.prompt !== "character references" && selectedImage.prompt !== "face generation" && (
              <button
                ...
                className="h-10 md:h-12 w-full flex items-center gap-2 px-3 border-[2px] border-[hsl(var(--border-mid))] text-xs md:text-sm font-[900] lowercase text-white text-left rounded-[1px] overflow-hidden"
            ...
            <a href={selectedImage.url} download={`facefox-${selectedImage.id}.png`} target="_blank" className="block">
              <button
                type="button"
                className="h-10 md:h-12 w-full flex items-center justify-center gap-2 border-[2px] border-[hsl(var(--border-mid))] text-xs md:text-sm font-[900] lowercase text-white rounded-[1px]"
                style={{ backgroundColor: "#000000" }}
              >
