  ...
  return (
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
                ...
                photoSlots.map((photo) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        borderRadius: 16,
                        border: isPlaceholder ? "none" : "2px solid #242424",
        ...
        {/* Desktop layout */}
        <main className="hidden md:block relative z-[1] w-full max-w-5xl mx-auto px-10 pt-14 pb-[280px]">
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <section className="col-span-8 flex flex-col p-5" style={{ backgroundColor: "#242424", border: "2px solid #242424", borderRadius: 18 }}>
                ...
                {photoSlots.map((photo) => {
                  ...
                  return (
                    <button
                      ...
                      style={{ borderRadius: 16, border: isPlaceholder ? "none" : "2px solid #242424", backgroundColor: "#242424" }}
                    >
                      <AspectRatio ratio={3 / 4}>
                        {isPlaceholder ? (
                          <div className="flex h-full w-full items-center justify-center text-white"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div>
          ...
          <section className="mt-6 p-5" style={{ backgroundColor: "#242424", border: "2px solid #242424", borderRadius: 18 }}>
            <div className="flex items-center justify-between mb-4">
              ...
              {[...charSlots, null, null].slice(0, 6).map((char, i) => {
                if (!char) {
                  return (
                    <button
                      ...
                      onClick={handleOpenCreator}
                      className="overflow-hidden active:scale-[0.98] transition-transform"
                      style={{ borderRadius: 16, backgroundColor: "#242424" }}
                    >
                      <AspectRatio ratio={3 / 4}>
                        <div className="flex h-full w-full items-center justify-center text-white"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div>
                      </AspectRatio>
                ...
                return (
                  <button
                    ...
                    onClick={() => navigate(`/characters/${char.id}`)}
                    className="relative overflow-hidden active:scale-[0.98] transition-transform"
                    style={{ borderRadius: 16, border: "2px solid #242424", backgroundColor: "#242424" }}
                  >
                    <AspectRatio ratio={3 / 4}>
                      {hasFace ? (
                        <img src={char.face_image_url!} alt={char.name} className="h-full w-full object-cover" onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} />
