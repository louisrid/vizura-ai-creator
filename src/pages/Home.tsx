  ...
  return (
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[24px] pt-[50px] pb-[140px] md:hidden">
          {/* Hero */}
          <h1 className="flex w-full flex-col items-start text-[44px] font-[900] lowercase leading-[0.94] tracking-[-1.6px] text-white mb-0 mt-[14px] text-left">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 3 }}>
                <button
                  ...
                  style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #ffe603", borderRadius: 3 }}
                >
                  see all →
                </button>
          ...
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 3 }}>
                <button onClick={() => { if (!user) { navigate("/auth?redirect=/characters"); return; } if (!onboardingComplete) return; navigate("/characters"); }} className="text-[11px] font-[800] lowercase px-3 py-1.5 transition-transform" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #ffe603", borderRadius: 3 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={10} />}
              </div>
        ...
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-[44px] pt-[62px] pb-[140px]">
          ...
          <section>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 3 }}>
                <button onClick={() => { if (!user) { navigate("/auth?redirect=/characters"); return; } if (!onboardingComplete) return; navigate("/characters"); }} className="text-[13px] font-[800] lowercase px-4 py-2 transition-transform hover-glow" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #ffe603", borderRadius: 3 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={10} />}
              </div>
          ...
          <div className="p-3 md:p-4 space-y-2" style={{ backgroundColor: "hsl(var(--card))", borderRadius: "0 0 10px 10px" }}>
            {selectedImage.prompt && selectedImage.prompt !== "character references" && selectedImage.prompt !== "face generation" && (
              <button
                ...
                className="h-10 md:h-12 w-full flex items-center gap-2 px-3 border-[2px] border-[hsl(var(--border-mid))] text-base md:text-lg font-[900] lowercase text-white text-left rounded-[3px] overflow-hidden"
                style={{ backgroundColor: "#000000" }}
              >
            ...
            <a href={selectedImage.url} download={`facefox-${selectedImage.id}.png`} target="_blank" className="block">
              <button
                type="button"
                className="h-10 md:h-12 w-full flex items-center justify-center gap-2 border-[2px] border-[hsl(var(--border-mid))] text-base md:text-lg font-[900] lowercase text-white rounded-[3px]"
                style={{ backgroundColor: "#000000" }}
              >
