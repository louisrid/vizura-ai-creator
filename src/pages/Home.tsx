  ...
  return (
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-1 pb-10 md:hidden">
          {/* Hero */}
        ...
        {/* Desktop layout */}
        <main className="hidden md:block relative z-[1] w-full max-w-5xl mx-auto px-10 pt-4 pb-10">
