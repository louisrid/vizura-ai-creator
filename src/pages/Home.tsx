    ...
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-14 pb-[280px] md:hidden">
          ...
          <div className="mt-3 mb-6" style={{ width: 60, height: 6, borderRadius: 3, backgroundColor: "#ffe414" }} />
          ...
          <section className="mb-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => navigate("/storage")} className="text-[11px] font-[800] lowercase px-3 py-1.5 active:scale-95 transition-transform" style={{ color: "#ffe414", backgroundColor: "#000000", border: "2px solid #ffe414", borderRadius: 12 }}>
                see all →
              </button>
            </div>
          ...
          <section className="mt-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => navigate("/characters")} className="text-[11px] font-[800] lowercase px-3 py-1.5 active:scale-95 transition-transform" style={{ color: "#ffe414", backgroundColor: "#000000", border: "2px solid #ffe414", borderRadius: 12 }}>
                manage →
              </button>
            </div>
            <div className="grid grid-cols-4 gap-2">
        ...
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-10 pt-14 pb-[280px]">
          ...
          <div className="mt-4 mb-10" style={{ width: 70, height: 7, borderRadius: 3, backgroundColor: "#ffe414" }} />
          ...
          <section className="mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => navigate("/storage")} className="text-[13px] font-[800] lowercase px-4 py-2 active:scale-95 transition-transform hover-glow" style={{ color: "#ffe414", backgroundColor: "#000000", border: "2px solid #ffe414", borderRadius: 12 }}>
                see all →
              </button>
            </div>
          ...
          <section className="mt-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => navigate("/characters")} className="text-[13px] font-[800] lowercase px-4 py-2 active:scale-95 transition-transform hover-glow" style={{ color: "#ffe414", backgroundColor: "#000000", border: "2px solid #ffe414", borderRadius: 12 }}>
                manage →
              </button>
            </div>
            <div className="grid grid-cols-4 gap-3">
