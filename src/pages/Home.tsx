        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-14 pb-[280px] md:hidden">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 2 }}>
                <button
                  ...
                  style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #eaeaea", borderRadius: 2 }}
                >
                  see all →
                </button>
          ...
          <section className="mt-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 2 }}>
                <button onClick={() => { if (!onboardingComplete) return; navigate("/characters"); }} className="text-[11px] font-[800] lowercase px-3 py-1.5 transition-transform" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #eaeaea", borderRadius: 2 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={4} />}
              </div>
        ...
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-10 pt-14 pb-[280px]">
          ...
          <section className="mt-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 2 }}>
                <button onClick={() => { if (!onboardingComplete) return; navigate("/characters"); }} className="text-[13px] font-[800] lowercase px-4 py-2 transition-transform hover-glow" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #eaeaea", borderRadius: 2 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={4} />}
              </div>
