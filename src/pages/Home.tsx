          ...
          <div className="p-3 md:p-4 space-y-2" style={{ backgroundColor: "hsl(var(--card))", borderRadius: "0 0 10px 10px" }}>
            {selectedImage.prompt && selectedImage.prompt !== "character references" && selectedImage.prompt !== "face generation" && (
              <button
                ...
                className="h-10 md:h-12 w-full flex items-center gap-2 px-3 border-[2.5px] border-[hsl(var(--border-mid))] text-base md:text-lg font-[900] lowercase text-white text-left rounded-[8px] overflow-hidden"
            ...
            <a href={selectedImage.url} download={`facefox-${selectedImage.id}.png`} target="_blank" className="block">
              <button
                type="button"
                className="h-10 md:h-12 w-full flex items-center justify-center gap-2 border-[2.5px] border-[hsl(var(--border-mid))] text-base md:text-lg font-[900] lowercase text-white rounded-[8px]"
                style={{ backgroundColor: "hsl(var(--card))" }}
              >
