        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[24px] pt-[50px] pb-[140px] md:hidden">
          ...
          <section className="mb-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 5 }}>
                <button
                  ...
                  style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #ffe603", borderRadius: 5 }}
                >
                  see all →
                </button>
          ...
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 5 }}>
                <button onClick={() => { if (!user) { navigate("/auth?redirect=/characters"); return; } if (!onboardingComplete) return; navigate("/characters"); }} className="text-[11px] font-[800] lowercase px-3 py-1.5 transition-transform" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #ffe603", borderRadius: 5 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={10} />}
              </div>
        ...
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-[44px] pt-[62px] pb-[140px]">
          ...
          <section>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="relative" style={{ overflow: "hidden", borderRadius: 5 }}>
                <button onClick={() => { if (!user) { navigate("/auth?redirect=/characters"); return; } if (!onboardingComplete) return; navigate("/characters"); }} className="text-[13px] font-[800] lowercase px-4 py-2 transition-transform hover-glow" style={{ color: "#ffffff", backgroundColor: "#000000", border: "2px solid #ffe603", borderRadius: 5 }}>
                  manage →
                </button>
                {!onboardingComplete && <LockOverlay borderRadius={10} />}
              </div>
        ...
        footer={selectedImage ? (
          <div className="p-3 md:p-4 space-y-2" style={{ backgroundColor: "hsl(var(--card))", borderRadius: "0 0 10px 10px" }}>
            ...
            <a href={selectedImage.url} download={`facefox-${selectedImage.id}.png`} target="_blank" className="block">
              <button
                type="button"
                className="h-10 md:h-12 w-full flex items-center justify-center gap-2 border-[2px] border-[hsl(var(--border-mid))] text-base md:text-lg font-[900] lowercase text-white rounded-[5px]"
                style={{ backgroundColor: "#000000" }}
              >
