  ...
  return (
    <div className={`relative min-h-[calc(100dvh-57px)] overflow-hidden ${pageHidden ? "bg-nav" : "bg-background"}`}>
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-14 pb-[140px] md:hidden">
          {/* Hero */}
        ...
        {/* Desktop layout */}
        <main className="hidden md:block relative z-[1] w-full max-w-5xl mx-auto px-10 pt-14 pb-[140px]">
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <section className="col-span-8 flex flex-col p-5" style={{ backgroundColor: "#1a1a1a", border: "2px solid #222", borderRadius: 18 }}>
                ...
                {photoSlots.map((photo) => {
                  ...
                  return (
                    <button
                      ...
                      style={{ borderRadius: 16, border: isPlaceholder ? "2px dashed #222" : "2px solid #222", backgroundColor: "#1a1a1a" }}
                    >
                      <AspectRatio ratio={3 / 4}>
                        {isPlaceholder ? (
          ...
          <section className="mt-6 p-5" style={{ backgroundColor: "#1a1a1a", border: "2px solid #222", borderRadius: 18 }}>
            <div className="flex items-center justify-between mb-4">
