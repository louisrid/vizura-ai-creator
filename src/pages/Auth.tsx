        ...
        <div className="w-full md:max-w-md">
          ...
          <div className="rounded-2xl border-2 border-[#1a1a1a] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "#1a1a1a" }}>
            <button
              ...
              className="w-full h-14 md:h-16 bg-neon-yellow text-neon-yellow-foreground text-sm md:text-base font-extrabold lowercase hover:opacity-90 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            ...
            <Button className="h-14 md:h-16 w-full text-sm md:text-base" onClick={handleEmailAuth} disabled={submitting || googleLoading}>
              {submitting ? (
                <>
                  <Loader2 className="animate-spin" size={18} />
                  signing in...
