...
const Auth = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[20px] pt-7 md:max-w-2xl md:px-[44px]">
        <div className="w-full md:max-w-md md:mx-auto">
          ...
          <div className="rounded-[8px] border-[3px] border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
            {!inWebView && (
              <>
                <button
                  ...
                  style={{ background: "#000000", color: "#ffffff", borderRadius: 8, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "3px solid #ffffff", WebkitTapHighlightColor: "transparent" }}
                >
                  {googleLoading ? (
                    <>
            ...
            <input
              ...
              spellCheck={false}
              autoCorrect="off"
              className="w-full h-12 md:h-14 border-[3px] border-[hsl(var(--border-mid))] px-4 text-base font-extrabold lowercase text-foreground placeholder:text-muted-foreground outline-none focus:border-neon-yellow transition-colors"
            ...
            <button
              ...
              disabled={submitting || googleLoading}
              className="w-full h-14 md:h-16 flex items-center justify-center gap-2 disabled:opacity-50 transition-transform duration-150"
              style={{ background: "#000000", color: "#ffffff", borderRadius: 8, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "3px solid #ffffff" }}
            >
              {submitting ? (
                <>
                  <Loader2 className="animate-spin" size={18} />
