        ...
        <div className="w-full md:max-w-md md:mx-auto">
          ...
          <div className="rounded-[10px] border-2 border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
            {!inWebView && (
              <>
                <button
                  ...
                  style={{ background: "linear-gradient(135deg, #d4b8ff, #c4a0ff)", color: "#000000", borderRadius: 10, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "none", WebkitTapHighlightColor: "transparent" }}
                >
                  {googleLoading ? (
                    <>
            ...
            <button
              ...
              disabled={submitting || googleLoading}
              className="w-full h-14 md:h-16 flex items-center justify-center gap-2 disabled:opacity-50 transition-transform duration-150"
              style={{ background: "linear-gradient(135deg, #d4b8ff, #c4a0ff)", color: "#000000", borderRadius: 10, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "none" }}
            >
              {submitting ? (
                <>
                  <Loader2 className="animate-spin" size={18} />
