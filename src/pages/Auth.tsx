        ...
        <div className="w-full md:max-w-md md:mx-auto">
          ...
          <div className="rounded-[8px] border-[3px] border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
            ...
            <input
              ...
              spellCheck={false}
              autoCorrect="off"
              className="w-full h-12 md:h-14 border-[3px] border-[hsl(var(--border-mid))] px-4 text-base font-extrabold lowercase text-foreground placeholder:text-white/60 outline-none focus:border-neon-yellow transition-colors"
