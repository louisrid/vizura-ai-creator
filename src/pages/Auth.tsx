...
const Auth = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      <DotDecal />
      <main className="relative z-[1] mx-auto w-full max-w-lg px-4 pt-1 pb-[140px]">
        ...
        <div className="rounded-2xl border-2 border-[#1e1e1e] p-5 space-y-3" style={{ backgroundColor: "#1e1e1e" }}>
          <button
          ...
          <input
            ...
            spellCheck={false}
            autoCorrect="off"
            className="w-full h-12 border-2 border-[#1e1e1e] px-4 text-base font-extrabold lowercase text-foreground placeholder:text-foreground/30 outline-none focus:border-neon-yellow transition-colors"
