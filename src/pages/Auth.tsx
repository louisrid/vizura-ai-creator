    ...
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-7 md:max-w-2xl md:px-[44px]">
        <div className="w-full md:max-w-md md:mx-auto">
          ...
          <div className="rounded-[8px] border-[1.75px] border-[hsl(var(--border-mid))] p-5 md:p-8 space-y-3 md:space-y-4" style={{ backgroundColor: "hsl(var(--card))" }}>
            {!inWebView && (
              <>
                <button
            ...
            <input
              ...
              spellCheck={false}
              autoCorrect="off"
              className="w-full h-12 md:h-14 border-[1.75px] border-[hsl(var(--border-mid))] px-4 text-base font-extrabold lowercase text-foreground placeholder:text-white/60 outline-none focus:border-neon-yellow transition-colors"
