            ...
            {!inWebView && (
              <>
                <button
                  ...
                  style={{ background: "#ffe603", color: "#000000", borderRadius: 5, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "none", WebkitTapHighlightColor: "transparent" }}
                >
                  {googleLoading ? (
                    <>
