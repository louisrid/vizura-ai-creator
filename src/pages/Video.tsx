...
const Video = () => (
  <div className="min-h-screen">
    <main className="w-full max-w-lg md:max-w-3xl mx-auto px-[20px] md:px-[44px] pt-[52px] pb-[140px] md:flex md:flex-col md:items-center md:justify-center md:min-h-screen md:pt-0 md:pb-0">
