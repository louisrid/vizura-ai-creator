  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-[1] w-full max-w-lg md:max-w-6xl mx-auto px-[32px] md:px-[56px] pt-[44px] pb-[280px]">
        ...
        {items.length === 0 ? (
          <div className="rounded-[7px] p-8 md:p-12 text-center md:max-w-md md:mx-auto" style={{ backgroundColor: "hsl(var(--card))", border: "2px solid hsl(var(--border-mid))" }}>
          ...
          <div className="space-y-4 md:grid md:grid-cols-3 lg:grid-cols-4 md:gap-5 md:space-y-0">
            {items.map((item) => (
              <button
                ...
                className="w-full text-left rounded-[7px] overflow-hidden transition-all hover:border-foreground/60 hover-lift"
