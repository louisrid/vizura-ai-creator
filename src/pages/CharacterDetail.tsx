      ...
      >
        ...
        {overlay === "regenerate" && (
          <button
            ...
            style={{ width: 28, height: 28, borderRadius: "50%", backgroundColor: "#050a10", border: "3px solid #00e0ff", top: -6, right: -6 }}
          >
            ...
            >
              ...
              <div className="flex gap-3 w-full">
                ...
                <button
                  ...
                  style={{ backgroundColor: "#1a0505", borderRadius: 8, border: "3px solid #ff4444", color: "#ff4444" }}
                >
