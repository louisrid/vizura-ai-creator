...
const CharacterDetail = () => {
  ...
  if (!character) {
    return (
      <div className="min-h-screen bg-background">
        <main className="mx-auto w-full max-w-lg md:max-w-3xl px-[14px] md:px-8 pt-1 pb-[220px]">
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="hidden md:block relative z-[1] mx-auto w-full max-w-3xl px-10 pt-1 pb-[220px]">
        <div className="flex items-center gap-3 mb-7">
          <BackButton />
        </div>
