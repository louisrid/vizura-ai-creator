...
const CharacterDetail = () => {
  ...
  if (loading || authLoading) {
    return (
      <div className="min-h-screen bg-background">
        <main className="mx-auto w-full max-w-lg md:max-w-3xl px-[14px] md:px-8 pt-5 pb-[280px]">
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      {/* Mobile layout */}
      <main className="relative z-[1] mx-auto w-full max-w-lg px-[14px] pt-5 pb-[280px] md:hidden" style={{ minHeight: "100dvh" }}>
...
<button onClick={() => setShowDelete(true)} className="active:scale-95 transition-transform">
      ...
      <main className="hidden md:block relative z-[1] mx-auto w-full max-w-5xl px-10 pt-5 pb-10 min-h-screen">
