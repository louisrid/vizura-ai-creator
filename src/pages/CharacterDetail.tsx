  ...
  const imgSlot = (
    ...
    return (
      <div
        ...
        style={{ borderRadius: 5, backgroundColor: "#000000" }}
        ...
        <div className="flex items-center gap-3 mb-11" style={{ position: "relative", zIndex: 10 }}>
          {onboardingComplete ? <BackButton /> : (
            <button
              ...
              style={{ borderRadius: 5, backgroundColor: "#ffe603" }}
              aria-label="go back"
            >
          ...
          <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }} className="p-5">
            {editingName ? (
              <div className="flex items-center gap-2 mb-5">
                ...
                <button onClick={saveEditName} disabled={savingName} className="flex items-center justify-center shrink-0" style={{ width: 52, height: 52, borderRadius: 5, backgroundColor: "#ffe603" }}>
...
<button onClick={() => setShowDelete(true)} className="active:scale-95 transition-transform">
          ...
          <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }} className="px-3 py-2">
            <div className="grid grid-cols-4 gap-1">
              {traits.map((t) => (
                <div key={t.label} className="rounded-[5px] py-2 text-center" style={{ backgroundColor: "hsl(var(--card))" }}>
                  ...
                  <span className={`inline-block font-[800] text-white leading-none text-[10px] border-[2px] border-[hsl(var(--border-mid))] rounded-[5px] ${t.value === "XL" ? "normal-case" : "lowercase"}`} style={{ backgroundColor: "hsl(var(--card))", padding: "4px 8px" }}>{t.value}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <main className="hidden md:block relative z-[1] mx-auto w-full max-w-5xl px-[56px] pt-7 pb-10 min-h-screen">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-7">
            <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }} className="p-6">
              {editingName ? (
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <button onClick={saveEditName} disabled={savingName} className="flex items-center justify-center shrink-0" style={{ width: 60, height: 60, borderRadius: 5, backgroundColor: "#ffe603" }}>
            ...
            {latestPhotos.length > 0 && (
              <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }} className="p-5 mt-5">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {Array.from({ length: 6 }).map((_, i) => {
                    ...
                    return (
                      ...
                      >
                        {photo && (
                          <img src={photo.url} alt="" className="h-full w-full absolute inset-0" style={{ objectFit: "cover", borderRadius: 5 }} />
                        )}
                      </div>
                    );
                  })}
            ...
            <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }} className="p-5">
              <h3 className="text-sm font-[900] lowercase text-white mb-3">traits</h3>
               <div className="grid grid-cols-2 gap-2">
                {traits.map((t) => (
                  <div key={t.label} className="rounded-[5px] px-3 py-2 text-center" style={{ backgroundColor: "hsl(var(--card))", border: "2px solid hsl(var(--border-mid))" }}>
        ...
        {showDelete && (
          ...
          >
            <motion.div
              ...
              style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5, border: "2px solid hsl(var(--border-mid))", padding: "28px 24px 24px" }}
            >
              ...
              <div className="flex gap-3 w-full">
                <button
                  ...
                  style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }}
                >
                  no
                </button>
                <button
                  ...
                  style={{ backgroundColor: "#1a0505", borderRadius: 5, border: "2px solid #ff4444", color: "#ff4444" }}
                >
