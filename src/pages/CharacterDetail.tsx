        ...
        <div className="flex items-center gap-3 mb-11" style={{ position: "relative", zIndex: 10 }}>
          {onboardingComplete ? <BackButton /> : (
            <button
              ...
              style={{ borderRadius: 8, backgroundColor: "#ffe603" }}
              aria-label="go back"
            >
          ...
          <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8 }} className="p-5">
            {editingName ? (
              <div className="flex items-center gap-2 mb-5">
                ...
                <button onClick={saveEditName} disabled={savingName} className="flex items-center justify-center shrink-0" style={{ width: 52, height: 52, borderRadius: 8, backgroundColor: "#ffe603" }}>
            ...
            <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8 }} className="p-6">
              {editingName ? (
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <button onClick={saveEditName} disabled={savingName} className="flex items-center justify-center shrink-0" style={{ width: 60, height: 60, borderRadius: 8, backgroundColor: "#ffe603" }}>
