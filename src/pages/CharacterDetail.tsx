          ...
          <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }} className="p-5">
            {editingName ? (
              <div className="flex items-center gap-2 mb-5">
                ...
                <button onClick={saveEditName} disabled={savingName} className="flex items-center justify-center shrink-0" style={{ width: 52, height: 52, borderRadius: 5, backgroundColor: "#ffffff" }}>
            ...
            <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 5 }} className="p-6">
              {editingName ? (
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <button onClick={saveEditName} disabled={savingName} className="flex items-center justify-center shrink-0" style={{ width: 60, height: 60, borderRadius: 5, backgroundColor: "#ffffff" }}>
