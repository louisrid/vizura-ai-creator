...
const CharacterDetail = () => {
  ...
  if (!character) {
    return (
      <div className="min-h-screen bg-background">
        <main className="mx-auto w-full max-w-lg md:max-w-3xl px-[14px] md:px-8 pt-10 pb-[140px]">
  ...
  const contentTop = (isMobile: boolean) => (
    <>
      {/* Box 1: Name + Photos */}
      <div style={{ backgroundColor: "#161616", borderRadius: 16 }} className={isMobile ? "p-5" : "p-6"}>
      ...
      {/* Details — compact */}
      <div style={{ backgroundColor: "#161616", borderRadius: 16 }} className={isMobile ? "px-4 py-3" : "p-4"}>
        <div className={`flex flex-wrap ${isMobile ? "gap-1.5" : "gap-2"}`}>
          {traits.map((t) => (
            <div key={t.label} className="rounded-[10px] px-3 py-1.5 text-center" style={{ backgroundColor: "#161616", border: "2px solid #222" }}>
