    ...
    return (
      ...
      >
        ...
        {overlay === "lock" && isValidImg(url) && (
          <div className="absolute flex items-center justify-center" style={{ width: 28, height: 28, borderRadius: "50%", backgroundColor: "#dddddd", top: -6, right: -6 }}>
          ...
          <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 2 }} className="p-5">
            {editingName ? (
              <div className="flex items-center gap-2 mb-5">
                ...
                <button onClick={saveEditName} disabled={savingName} className="flex items-center justify-center shrink-0" style={{ width: 52, height: 52, borderRadius: 2, backgroundColor: "#dddddd" }}>
      ...
      <div className="fixed inset-x-0 bottom-0 z-[2] md:hidden">
        <div className="mx-auto w-full max-w-lg px-[14px] pt-12" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 10px)", background: "linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.95) 25%, rgba(0,0,0,0.7) 50%, rgba(0,0,0,0.3) 70%, transparent 100%)" }}>
          <button
            ...
            style={{ height: 52, color: "#ffffff", borderRadius: 2, backgroundColor: "#000000", border: "2px solid #dddddd", padding: "0 16px" }}
          >
        ...
        <div className="grid grid-cols-12 gap-8">
            ...
            <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 2 }} className="p-6">
              {editingName ? (
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <button onClick={saveEditName} disabled={savingName} className="flex items-center justify-center shrink-0" style={{ width: 60, height: 60, borderRadius: 2, backgroundColor: "#dddddd" }}>
          ...
          <div className="col-span-5 flex flex-col gap-5">
            ...
            <button
              ...
              style={{ color: "#ffffff", borderRadius: 2, backgroundColor: "#000000", border: "2px solid #dddddd" }}
            >
              <span className="flex items-center justify-center gap-2">
                create photo <Camera size={18} strokeWidth={3} />
              </span>
