...
const CharacterDetail = () => {
  ...
  if (loading || (authLoading && !hasCachedUser)) {
    return (
      <div className="relative min-h-screen bg-background overflow-hidden">
        <main className="relative z-[1] mx-auto w-full max-w-lg md:max-w-3xl px-[18px] md:px-[44px] pt-[44px] pb-[200px]">
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      {/* Mobile layout */}
      <main className="relative z-[1] mx-auto w-full max-w-lg px-[18px] pt-7 pb-4 md:hidden" style={{ minHeight: "100dvh", overflow: "hidden" }}>
...
<button onClick={() => setShowDelete(true)} className="active:scale-95 transition-transform">
      ...
      <div className="fixed inset-x-0 bottom-0 z-[2] md:hidden">
        <div className="mx-auto w-full max-w-lg px-[18px] pt-12" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 10px)", background: "linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.95) 25%, rgba(0,0,0,0.7) 50%, rgba(0,0,0,0.3) 70%, transparent 100%)" }}>
          <button
