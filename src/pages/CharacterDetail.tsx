  ...
  const imgSlot = (
    ...
    return (
      <div
        ...
        style={{ borderRadius: 6, backgroundColor: "#000000" }}
...
<button onClick={() => setShowDelete(true)} className="active:scale-95 transition-transform">
          ...
          <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 6 }} className="px-3 py-2">
            <div className="grid grid-cols-4 gap-1">
              {traits.map((t) => (
                <div key={t.label} className="rounded-[6px] py-2 text-center" style={{ backgroundColor: "hsl(var(--card))" }}>
                  ...
                  <span className={`inline-block font-[800] text-white leading-none text-[10px] border-[2px] border-[hsl(var(--border-mid))] rounded-[6px] ${t.value === "XL" ? "normal-case" : "lowercase"}`} style={{ backgroundColor: "#000000", padding: "4px 8px" }}>{t.value}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="fixed inset-x-0 bottom-0 z-[2] md:hidden">
        <div className="mx-auto w-full max-w-lg px-[14px] pt-12" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 10px)", background: "linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.95) 25%, rgba(0,0,0,0.7) 50%, rgba(0,0,0,0.3) 70%, transparent 100%)" }}>
          <button
            ...
            style={{ height: 52, color: "#ffffff", borderRadius: 6, backgroundColor: "#000000", border: "2px solid #ffe603", padding: "0 16px" }}
          >
        ...
        <div className="grid grid-cols-12 gap-8">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {Array.from({ length: 6 }).map((_, i) => {
                    ...
                    return (
                      ...
                      >
                        {photo && (
                          <img src={photo.url} alt="" className="h-full w-full absolute inset-0" style={{ objectFit: "cover", borderRadius: 6 }} />
                        )}
                      </div>
                    );
                  })}
          ...
          <div className="col-span-5 flex flex-col gap-5">
            <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 6 }} className="p-5">
              <h3 className="text-sm font-[900] lowercase text-white mb-3">traits</h3>
               <div className="grid grid-cols-2 gap-2">
                {traits.map((t) => (
                  <div key={t.label} className="rounded-[6px] px-3 py-2 text-center" style={{ backgroundColor: "#000000", border: "2px solid hsl(var(--border-mid))" }}>
            ...
            <button
              ...
              style={{ color: "#ffffff", borderRadius: 6, backgroundColor: "#000000", border: "2px solid #ffe603" }}
            >
              <span className="flex items-center justify-center gap-2">
                create photo <Camera size={18} strokeWidth={3} />
              </span>
        ...
        {showDelete && (
          ...
          >
            <motion.div
              ...
              style={{ backgroundColor: "#000000", borderRadius: 6, border: "2px solid hsl(var(--border-mid))", padding: "28px 24px 24px" }}
            >
