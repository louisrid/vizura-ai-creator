    ...
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-[1] w-full max-w-lg md:max-w-5xl mx-auto px-4 md:px-10 pt-10 pb-[140px]">
        ...
        {loading ? (
          ...
          <div className="border-2 border-[#222] rounded-2xl p-8 text-center" style={{ backgroundColor: "#1a1a1a" }}>
        ...
        {expanded && (
          ...
          >
            <motion.div
              ...
              style={{ backgroundColor: "#1a1a1a", borderRadius: 16, border: "2px solid #222" }}
