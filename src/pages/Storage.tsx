  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg md:max-w-6xl mx-auto px-[24px] md:px-[48px] pt-[34px] pb-[140px]">
        <div className="flex items-center gap-[14px] mb-14">
          ...
          <button
            ...
            style={{
              ...
              border: "1.75px solid hsl(var(--border-mid))",
            }}
        ...
        {images.length === 0 ? (
          <div className="rounded-[8px] p-8 md:p-12 text-center md:max-w-md md:mx-auto" style={{ backgroundColor: "hsl(var(--card))", border: "1.75px solid hsl(var(--border-mid))" }}>
          ...
          <>
            {expanded.prompt && expanded.prompt !== "character references" && expanded.prompt !== "face generation" && (
              <div className="px-3 md:px-4 pt-3 pb-1" style={{ backgroundColor: "hsl(var(--card))" }}>
                <button
                   ...
                   className="h-10 md:h-12 w-full flex items-center gap-2 px-3 border-[1.75px] border-[hsl(var(--border-mid))] text-base md:text-lg font-[900] lowercase text-white text-left rounded-[8px] overflow-hidden"
            ...
            <div className="p-3 md:p-4 flex gap-2" style={{ backgroundColor: "hsl(var(--card))", borderRadius: "0 0 10px 10px" }}>
              <a href={expanded.url} download={`facefox-${expanded.id}.png`} target="_blank" className="flex-1">
                <Button variant="outline" className="w-full h-10 md:h-12 border-[1.75px] border-[hsl(var(--border-mid))] text-base md:text-lg font-[900] lowercase hover:opacity-90" style={{ backgroundColor: "hsl(var(--card))", color: "#ffffff" }}>
