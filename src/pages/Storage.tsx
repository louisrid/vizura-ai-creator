  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg md:max-w-6xl mx-auto px-[24px] md:px-[48px] pt-[42px] pb-[140px]">
        ...
        {images.length === 0 ? (
          <div className="rounded-[8px] p-8 md:p-12 text-center md:max-w-md md:mx-auto" style={{ backgroundColor: "hsl(var(--card))", border: "2.5px solid hsl(var(--border-mid))" }}>
          ...
          <>
            ...
            <div className="p-3 md:p-4 flex gap-2" style={{ backgroundColor: "hsl(var(--card))", borderRadius: "0 0 10px 10px" }}>
              <a href={expanded.url} download={`facefox-${expanded.id}.png`} target="_blank" className="flex-1">
                <Button variant="outline" className="w-full h-10 md:h-12 border-[2.5px] border-[hsl(var(--border-mid))] text-base md:text-lg font-[900] lowercase hover:opacity-90" style={{ backgroundColor: "hsl(var(--card))", color: "#ffffff" }}>
