  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg md:max-w-6xl mx-auto px-[20px] md:px-[44px] pt-[44px] pb-[140px]">
        ...
        {images.length === 0 ? (
          <div className="rounded-[8px] p-8 md:p-12 text-center md:max-w-md md:mx-auto" style={{ backgroundColor: "hsl(var(--card))", border: "3px solid hsl(var(--border-mid))" }}>
        ...
        footer={expanded ? (
          <>
            ...
            <div className="p-3 md:p-4 flex gap-2" style={{ backgroundColor: "hsl(var(--card))", borderRadius: "0 0 10px 10px" }}>
              ...
              <Button
                variant="outline"
                className="h-10 md:h-12 px-3 md:px-4 border-[3px] border-destructive bg-[#1a0808] text-destructive hover:bg-destructive hover:text-destructive-foreground"
