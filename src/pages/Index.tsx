...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      {/* Mobile layout */}
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[20px] pt-[80px] pb-[160px] md:hidden">
      ...
      <main className="hidden md:block relative z-[1] w-full max-w-6xl mx-auto px-[44px] pt-[80px] pb-[140px]">
        <div className="flex items-center gap-[14px] mb-14">
          <BackButton always />
          <PageTitle className="mb-0">create photo</PageTitle>
        </div>
