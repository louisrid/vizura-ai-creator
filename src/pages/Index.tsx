...
const ToggleBox = ({ label, options, value, onChange }: {
  ...
  <div className="flex-1 flex flex-col gap-2">
    ...
    <div className="flex items-stretch rounded-[8px] border-[2.5px] border-[hsl(var(--border-mid))] overflow-hidden" style={{ backgroundColor: "hsl(var(--card))" }}>
      {options.map((opt, i) => {
...
const HighlightedPromptArea = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-[8px] border-[2.5px] border-[hsl(var(--border-mid))] bg-card">
      <textarea
        value={value}
      ...
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-[42px] pb-[160px] md:hidden">
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="flex flex-col gap-5 mt-3" style={{ overflowAnchor: "none" }}>
            <div className="relative rounded-[8px] border-[2.5px] border-[hsl(var(--border-mid))] bg-card overflow-hidden">
