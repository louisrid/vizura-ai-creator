        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              style={{ borderRadius: 1, border: "2px solid hsl(var(--border-mid))", backgroundColor: "#000000", boxShadow: "0 8px 32px rgba(0,0,0,0.8)" }}
            >
              {RATIO_OPTIONS.map((opt, idx) => (
                <div key={opt.value}>
                  ...
                  <button
                    ...
                    style={{
                      color: value === opt.value ? "#eaeaea" : "#ffffff",
...
const ToggleBox = ({ label, options, value, onChange }: {
  ...
  <div className="flex-1 flex flex-col gap-2">
    ...
    <div className="flex items-stretch rounded-[1px] border-2 border-[hsl(var(--border-mid))] overflow-hidden" style={{ backgroundColor: "hsl(var(--card))" }}>
      {options.map((opt, i) => {
...
const HighlightedPromptArea = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-[1px] border-2 border-input bg-card">
      <textarea
        value={value}
...
const PhotoTypeDropdown = ({ value, onChange }: { value: string; onChange: (v: string) => void }) => {
  const [open, setOpen] = useState(false);
  const ref = useRef<HTMLDivElement>(null);
  const selected = PHOTO_TYPE_OPTIONS.find((o) => o.value === value) ?? PHOTO_TYPE_OPTIONS[0];
  ...
  return (
    <div className="flex-1">
      <span className="block text-lg md:text-xl font-[900] lowercase mb-2 text-white">type</span>
      <div className="relative" ref={ref}>
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
...
const CreateButton = ({ onClick, disabled, isGenerating, onboardingComplete }: {
  ...
  <button
    ...
    style={{ backgroundColor: "#050a10", color: "#ffffff", border: "2px solid #00e0ff", borderRadius: 1 }}
    onClick={onClick}
    disabled={disabled}
  >
    {isGenerating ? (
...
const Index = () => {
              ...
              <Fragment key={c.id}>
                ...
                >
                  ...
                  <span
                    ...
                    style={{ color: isSelected ? "#eaeaea" : "#ffffff" }}
                  >
                    {c.name || "unnamed"}
                  </span>
                </button>
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Mobile layout */}
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[14px] pt-7 pb-[120px] md:hidden">
        ...
        <div className="flex flex-col gap-7">
          <div className="w-[75%] mx-auto flex flex-col gap-5">
            ...
            <div className="relative rounded-[1px] border-2 border-input bg-card overflow-hidden">
              <motion.section
                layout
              ...
              >
                ...
                {resultImage ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center">
                    <div className="flex items-center justify-center rounded-full" style={{ width: 48, height: 48, backgroundColor: "rgba(250,204,21,0.08)", border: "2px solid #eaeaea" }}>
        ...
        {error && (
          <div className="mt-4 rounded-[1px] border-[2px] border-destructive/30 bg-destructive/5 p-4 text-sm font-extrabold lowercase text-destructive">
            {error}
          </div>
        )}
      </main>
      ...
      <main className="hidden md:block relative z-[1] w-full max-w-6xl mx-auto px-10 pt-7 pb-[280px]">
            ...
            <div className="relative rounded-[1px] border-2 border-input bg-card overflow-hidden">
              ...
              >
                ...
                {resultImage ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center">
                    <div className="flex items-center justify-center rounded-full" style={{ width: 64, height: 64, backgroundColor: "rgba(250,204,21,0.08)", border: "2px solid #eaeaea" }}>
