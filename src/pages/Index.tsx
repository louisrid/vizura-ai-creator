...
const ToggleBox = ({ label, options, value, onChange }: {
  ...
  <div className="flex-1 flex flex-col gap-2">
    ...
    <div className="flex items-stretch rounded-[9px] border-2 border-[hsl(var(--border-mid))] overflow-hidden" style={{ backgroundColor: "hsl(var(--card))" }}>
      {options.map((opt, i) => {
...
const HighlightedPromptArea = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-[9px] border-2 border-[hsl(var(--border-mid))] bg-card">
      <textarea
        value={value}
      ...
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[32px] pt-[44px] pb-[110px] md:hidden">
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="w-[75%] mx-auto flex flex-col gap-5 mt-5" style={{ overflowAnchor: "none" }}>
            <div className="relative rounded-[9px] border-2 border-[hsl(var(--border-mid))] bg-card overflow-hidden">
        ...
        {error && (
          <div className="mt-4 rounded-[9px] border-[2px] border-destructive/30 bg-destructive/5 p-4 text-sm font-extrabold lowercase text-destructive">
            {error}
          </div>
        )}
      </main>
      ...
      <main className="hidden md:block relative z-[1] w-full max-w-6xl mx-auto px-[56px] pt-[44px] pb-[280px]">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-5 flex flex-col gap-5">
            ...
            <div className="relative rounded-[9px] border-2 border-[hsl(var(--border-mid))] bg-card overflow-hidden mt-3">
              <div className="w-full" style={{ aspectRatio: previewAspect }}>
                {resultImage ? (
                  <img
                    src={resultImage}
