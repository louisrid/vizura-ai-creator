...
const ToggleBox = ({ label, options, value, onChange }: {
  ...
  <div className="flex-1 flex flex-col gap-2">
    ...
    <div className="flex items-stretch rounded-[8px] border-[1.5px] border-[hsl(var(--border-mid))] overflow-hidden" style={{ backgroundColor: "hsl(var(--card))" }}>
      {options.map((opt, i) => {
...
const HighlightedPromptArea = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-[8px] border-[1.5px] border-[hsl(var(--border-mid))] bg-card">
      <textarea
        value={value}
...
const CreateButton = ({ onClick, disabled, isGenerating, onboardingComplete }: {
  ...
  <button
    ...
    style={{ backgroundColor: "#050a10", color: "#ffffff", border: "1.5px solid #00e0ff", borderRadius: 8 }}
    onClick={onClick}
    disabled={disabled}
  >
    {isGenerating ? (
...
const Index = () => {
        ...
        >
          ...
          {characters.length === 0 && user && (
            <div>
              ...
              >
                <div className="w-8 h-8 rounded-full shrink-0 flex items-center justify-center" style={{ backgroundColor: "rgba(250,204,21,0.1)", border: "1.5px solid rgba(250,204,21,0.3)" }}>
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      {/* Mobile layout */}
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[20px] pt-[44px] pb-[160px] md:hidden">
        ...
        <div className="flex flex-col gap-7">
          <div className="relative" ref={dropdownRef}>
            ...
            >
              {selectedChar?.face_image_url ? (
                <div className="w-9 h-9 rounded-full overflow-hidden shrink-0 border-[1.5px] border-black/15">
          ...
          <div className="flex flex-col gap-5 mt-3" style={{ overflowAnchor: "none" }}>
            <div className="relative rounded-[8px] border-[1.5px] border-[hsl(var(--border-mid))] bg-card overflow-hidden">
              <div className="w-full" style={{ aspectRatio: previewAspect }}>
                {resultImage ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center">
                    <div className="flex items-center justify-center rounded-full" style={{ width: 48, height: 48, backgroundColor: "rgba(250,204,21,0.08)", border: "1.5px solid #ffe603" }}>
        ...
        {error && (
          <div className="mt-4 rounded-[8px] border-[1.5px] border-destructive/30 bg-destructive/5 p-4 text-sm font-extrabold lowercase text-destructive">
            {error}
          </div>
        )}
      </main>
      ...
      <main className="hidden md:block relative z-[1] w-full max-w-6xl mx-auto px-[44px] pt-[44px] pb-[140px]">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-7 flex flex-col gap-5">
            <div className="relative" ref={dropdownRef2}>
              ...
              >
                {selectedChar?.face_image_url ? (
                  <div className="w-11 h-11 rounded-full overflow-hidden shrink-0 border-[1.5px] border-black/15">
                    <img src={selectedChar.face_image_url} alt="" className="w-full h-full object-cover" />
                  </div>
                ) : (
            ...
            <div className="relative rounded-[8px] border-[1.5px] border-[hsl(var(--border-mid))] bg-card overflow-hidden">
              <div className="w-full" style={{ aspectRatio: previewAspect }}>
                {resultImage ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center">
                    <div className="flex items-center justify-center rounded-full" style={{ width: 64, height: 64, backgroundColor: "rgba(250,204,21,0.08)", border: "1.5px solid #ffe603" }}>
