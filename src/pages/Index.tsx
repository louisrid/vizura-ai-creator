    ...
    <div className="min-h-screen bg-background">
      <PaywallOverlay open={showPaywall} onClose={() => setShowPaywall(false)} />
        ...
        <main className="w-full max-w-lg mx-auto px-4 pt-12 pb-12">
          ...
          <div className="relative mb-10 overflow-hidden rounded-2xl border-[3.5px] border-border bg-card aspect-[4/5]">
            {primaryImage ? (
              <>
          ...
          <div className="space-y-10">
            <div>
              ...
              <input
                ...
                className="w-full border-[3.5px] border-border bg-background text-foreground px-4 py-4 text-sm font-extrabold lowercase placeholder:text-foreground focus:outline-none focus:border-foreground rounded-2xl transition-colors"
              />
            </div>
                ...
                {stylePresets.map((style, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-1.5 py-4 rounded-2xl font-extrabold lowercase text-sm border-[3.5px] transition-all ${
                        activeStyle === i
          ...
          {error && (
            <div className="border-[3.5px] border-destructive/30 bg-destructive/5 p-4 text-destructive font-extrabold lowercase text-sm rounded-2xl mt-10">
              {error}
            </div>
          )}
