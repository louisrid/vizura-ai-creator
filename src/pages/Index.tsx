            ...
            >
              {EXPRESSION_OPTIONS.map((opt) => (
                <button
                  ...
                  style={{ color: value === opt.value ? "#fcdb08" : "#fff" }}
                >
                  {opt.label}
                </button>
              ))}
        ...
        >
          {characters.map((c) => (
            ...
            >
              ...
              <span
                ...
                style={{ color: selectedCharId === c.id ? "#fcdb08" : "#fff" }}
              >
                {c.name || "unnamed"}
              </span>
            </button>
          ...
          {characters.length === 0 && user && (
            ...
            >
              ...
              <span className="text-lg font-[900] lowercase" style={{ color: "#fcdb08" }}>create character</span>
            </button>
          )}
        </motion.div>
      )}
              ...
              <motion.div layout className="w-full" style={{ aspectRatio: previewAspect }}>
                {resultImage ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center">
                    <div className="flex items-center justify-center rounded-full" style={{ width: 48, height: 48, backgroundColor: "rgba(250,204,21,0.08)", border: "2px solid #fcdb08" }}>
          ...
          <div className="col-span-5 flex flex-col gap-5">
            <div className="relative" ref={dropdownRef2}>
              <button
                ...
                style={{ borderRadius: 14, backgroundColor: "#fcdb08" }}
              >
                {selectedChar?.face_image_url ? (
            ...
            >
              <motion.div layout className="w-full" style={{ aspectRatio: previewAspect }}>
                {resultImage ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center">
                    <div className="flex items-center justify-center rounded-full" style={{ width: 64, height: 64, backgroundColor: "rgba(250,204,21,0.08)", border: "2px solid #fcdb08" }}>
