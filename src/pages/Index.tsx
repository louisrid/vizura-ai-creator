...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Mobile layout */}
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[32px] pt-[38px] pb-[110px] md:hidden">
      ...
      <main className="hidden md:block relative z-[1] w-full max-w-6xl mx-auto px-[56px] pt-[38px] pb-[280px]">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-5 flex flex-col gap-5">
            ...
            <div className="relative rounded-[10px] border-2 border-[hsl(var(--border-mid))] bg-card overflow-hidden mt-3">
              <div className="w-full" style={{ aspectRatio: previewAspect }}>
                {resultImage ? (
                  <img
                    src={resultImage}
