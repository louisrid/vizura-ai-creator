...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
                    ...
                    {characters.map((c) => (
                      ...
                      >
                        {c.face_image_url ? (
                          ...
                          <div className="w-8 h-8 rounded-full shrink-0 flex items-center justify-center" style={{ backgroundColor: "#1a1a1a" }}>
      ...
      <div className="fixed left-0 right-0 bottom-0 z-10 px-[14px]" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 28px)", background: "linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.95) 25%, rgba(0,0,0,0.7) 50%, rgba(0,0,0,0.3) 70%, transparent 100%)", paddingTop: 48 }}>
