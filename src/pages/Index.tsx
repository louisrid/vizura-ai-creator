...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Mobile layout */}
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[32px] pt-[60px] pb-[120px] md:hidden">
      ...
      <main className="hidden md:block relative z-[1] w-full max-w-6xl mx-auto px-[56px] pt-[60px] pb-[280px]">
