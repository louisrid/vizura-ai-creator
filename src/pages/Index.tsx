    ...
    <div>
      ...
      <div className="relative" ref={ref}>
        <button
          ...
          style={{ borderRadius: 12, backgroundColor: "#2a2a2a", border: "2px solid #2a2a2a" }}
        >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              style={{ borderRadius: 12, border: "2px solid #2a2a2a", backgroundColor: "#2a2a2a" }}
            >
...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
                    ...
                    {characters.map((c) => (
                      ...
                      >
                        {c.face_image_url ? (
                          ...
                          <div className="w-8 h-8 rounded-full shrink-0 flex items-center justify-center" style={{ backgroundColor: "#2a2a2a" }}>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 px-6 pb-[calc(env(safe-area-inset-bottom,0px)+8px)] pt-2 bg-gradient-to-t from-background via-background/95 to-transparent">
