          ...
          <div className="space-y-10">
            <div>
              ...
              <input
                ...
                className="w-full border-[4px] border-border bg-background text-foreground px-4 py-4 text-sm font-extrabold lowercase placeholder:text-foreground/30 focus:outline-none focus:border-foreground rounded-2xl transition-colors"="w-full border-[4px] border-border bg-background text-foreground px-4 py-4 text-sm font-extrabold lowercase placeholder:text-foreground/30 focus:outline-none focus:border-foreground rounded-2xl transition-colors" focus:border-foreground rounded-2xl transition-colors"
              />
            </div>
