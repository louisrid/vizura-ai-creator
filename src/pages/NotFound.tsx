...
const NotFound = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      <DotDecal />
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[32px] pt-[38px] pb-[280px]">
        <div className="flex items-center gap-3 mb-11">
          <BackButton />
          <PageTitle className="mb-0">not found</PageTitle>
        </div>
        <div className="border-2 border-[hsl(var(--border-mid))] rounded-[10px] p-6 text-center" style={{ backgroundColor: "hsl(var(--card))" }}>
