...
const NotFound = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[20px] pt-[42px] pb-[140px]">
        <div className="flex items-center gap-[14px] mb-14">
          <BackButton />
          <PageTitle className="mb-0">not found</PageTitle>
        </div>
        <div className="border-[1px] border-[hsl(var(--border-mid))] rounded-[8px] p-6 text-center" style={{ backgroundColor: "hsl(var(--card))" }}>
