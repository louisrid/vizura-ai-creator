...
const ComingSoon = ({ title }: { title: string }) => (
  <div className="min-h-screen bg-background">
    <main className="w-full max-w-lg md:max-w-3xl mx-auto px-[24px] md:px-10 pt-12 pb-[280px] md:flex md:flex-col md:items-center md:justify-center md:min-h-screen md:pt-0 md:pb-0">
      <div className="w-full">
        <div className="flex items-center gap-3 mb-8">
          <BackButton />
          <PageTitle className="mb-0">{title}</PageTitle>
        </div>
        <div className="border-[2.5px] border-neon-yellow rounded-[3px] p-8 md:p-12 text-center bg-card md:max-w-md md:mx-auto">
