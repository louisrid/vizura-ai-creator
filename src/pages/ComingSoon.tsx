...
const ComingSoon = ({ title }: { title: string }) => (
  <div className="min-h-screen bg-background">
    <main className="w-full max-w-lg md:max-w-3xl mx-auto px-[32px] md:px-[56px] pt-[44px] pb-[140px] md:flex md:flex-col md:items-center md:justify-center md:min-h-screen md:pt-0 md:pb-0">
