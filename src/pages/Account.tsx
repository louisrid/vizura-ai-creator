        ...
        <div className="flex flex-col">
          ...
          <div className="mt-7">
            <div className="space-y-3 md:space-y-0 md:grid md:grid-cols-2 md:gap-3">
              <div className="border-[1.5px] border-[#1a1a1a] p-3 md:p-4 flex items-center gap-3" style={{ borderRadius: 12, backgroundColor: "#111111" }}>
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-[1] mx-auto w-full max-w-lg md:max-w-3xl px-4 md:px-10 pt-1 pb-[250px]">
        ...
        <div className="border-[1.5px] border-[#1a1a1a] p-5 space-y-3 max-w-md md:max-w-lg" style={{ borderRadius: 12, backgroundColor: "#111111" }}>
          <button
          ...
          <input
            ...
            spellCheck={false}
            autoCorrect="off"
            className="w-full h-12 border-[1.5px] border-[#1a1a1a] px-4 text-2xl font-extrabold lowercase text-foreground placeholder:text-foreground/30 outline-none focus:border-neon-yellow transition-colors"
