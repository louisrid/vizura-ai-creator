  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[32px] pt-[44px] pb-[280px] flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-3">
          <button
            className="w-full rounded-[8px] border-[2px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-between px-5 py-4 transition-colors hover:bg-card"
          ...
          {user?.email === "louisjridland@gmail.com" && (
            <button
              className="w-full rounded-[8px] border-[2px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-center gap-2 px-5 py-4 text-sm font-[900] lowercase text-white transition-colors hover:bg-card"
