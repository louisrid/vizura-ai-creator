    ...
    <div className="relative min-h-screen bg-background overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-[44px] pb-[200px] flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-2">
          <button
            className="w-full rounded-[5px] border-[2px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-between px-4 py-3 transition-colors hover:bg-card"
          ...
          {user?.email === "louisjridland@gmail.com" && (
            <button
              className="w-full rounded-[5px] border-[2px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-center gap-2 px-4 py-3 text-xs font-[900] lowercase text-white transition-colors hover:bg-card"
      ...
      <main className="relative z-[1] mx-auto w-full max-w-lg px-[24px] pt-[44px] pb-[140px] flex flex-col items-center">
        ...
        <div className="w-full p-5 space-y-3" style={{ borderRadius: 5, backgroundColor: "hsl(var(--card))", border: "2px solid hsl(var(--border-mid))" }}>
          <button
            ...
            style={{ background: "#ffffff", color: "#000000", borderRadius: 5, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "none" }}
          >
            {googleLoading ? (
