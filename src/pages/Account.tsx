    ...
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-[34px] pb-[140px] flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-2.5 self-center">
          <button
            className="w-full rounded-[9.6px] border-[1.75px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-between px-4 h-14 text-[13px] font-[900] lowercase text-white"
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] mx-auto w-full max-w-lg px-[24px] pt-[34px] pb-[140px] flex flex-col items-center">
        ...
        <div className="w-full p-5 space-y-3" style={{ borderRadius: 9.6, backgroundColor: "hsl(var(--card))", border: "1.75px solid hsl(var(--border-mid))" }}>
          <button
          ...
          <input
            ...
            spellCheck={false}
            autoCorrect="off"
            className="w-full h-12 border-[1.75px] border-[hsl(var(--border-mid))] px-4 text-base font-extrabold lowercase text-foreground placeholder:text-white/60 outline-none focus:border-neon-yellow transition-colors"
