      ...
      <div className="relative min-h-screen bg-background overflow-hidden">
        ...
        <main className="relative z-[1] w-full max-w-lg mx-auto px-[32px] pt-[44px] pb-[280px] flex flex-col items-center">
          <div className="flex items-center gap-3 mb-11 w-full">
            <div className="w-[40px] h-[40px]" style={{ borderRadius: 9, backgroundColor: "hsl(var(--card))" }} />
            <div className="h-7 w-28" style={{ borderRadius: 9, backgroundColor: "hsl(var(--card))" }} />
          </div>
          <div className="flex flex-col items-center mb-8">
            <div className="w-20 h-20 rounded-full mb-3" style={{ backgroundColor: "hsl(var(--card))" }} />
            <div className="h-4 w-40" style={{ borderRadius: 9, backgroundColor: "hsl(var(--card))" }} />
          </div>
          <div className="w-full flex flex-col gap-3">
            <div className="w-full h-14" style={{ borderRadius: 9, backgroundColor: "hsl(var(--card))" }} />
            <div className="w-full h-14" style={{ borderRadius: 9, backgroundColor: "hsl(var(--card))" }} />
          </div>
        </main>
      </div>
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[32px] pt-[44px] pb-[280px] flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-3">
          <button
            className="w-full rounded-[9px] border-[2px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-between px-5 py-4 transition-colors hover:bg-card"
          ...
          {user?.email === "louisjridland@gmail.com" && (
            <button
              className="w-full rounded-[9px] border-[2px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-center gap-2 px-5 py-4 text-sm font-[900] lowercase text-white transition-colors hover:bg-card"
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-[1] mx-auto w-full max-w-lg px-[32px] pt-[44px] pb-[280px] flex flex-col items-center">
        ...
        <div className="w-full p-5 space-y-3" style={{ borderRadius: 9, backgroundColor: "hsl(var(--card))", border: "2px solid hsl(var(--border-mid))" }}>
          <button
            ...
            style={{ background: "#ffe603", color: "#000000", borderRadius: 9, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "none" }}
          >
            {googleLoading ? (
