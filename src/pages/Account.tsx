        ...
        <div className="flex flex-col">
          ...
          <div className="mt-7">
            <div className="space-y-3 md:space-y-0 md:grid md:grid-cols-2 md:gap-3">
              <div className="border-2 border-[#1a1a1a] p-3 md:p-4 flex items-center gap-3" style={{ borderRadius: 12, backgroundColor: "#2a2a2a" }}>
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-[1] mx-auto w-full max-w-lg md:max-w-3xl px-4 md:px-10 pt-10 pb-[280px]">
        ...
        <div className="border-2 border-[#1a1a1a] p-5 space-y-3 max-w-md md:max-w-lg" style={{ borderRadius: 12, backgroundColor: "#2a2a2a" }}>
          <button
