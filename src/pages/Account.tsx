  ...
  if (authLoading && !hasCachedUser) {
    return (
      <div className="relative min-h-screen bg-background overflow-hidden">
        <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-[44px] pb-[140px] flex flex-col items-center">
          <div className="flex items-center gap-3 mb-11 w-full">
            <div className="w-[40px] h-[40px]" style={{ borderRadius: 3, backgroundColor: "hsl(var(--card))" }} />
            <div className="h-7 w-28" style={{ borderRadius: 3, backgroundColor: "hsl(var(--card))" }} />
          </div>
          <div className="flex flex-col items-center mb-8">
            <div className="w-20 h-20 rounded-full mb-3" style={{ backgroundColor: "hsl(var(--card))" }} />
            <div className="h-4 w-40" style={{ borderRadius: 3, backgroundColor: "hsl(var(--card))" }} />
          </div>
          <div className="w-full flex flex-col gap-3">
            <div className="w-full h-14" style={{ borderRadius: 3, backgroundColor: "hsl(var(--card))" }} />
            <div className="w-full h-14" style={{ borderRadius: 3, backgroundColor: "hsl(var(--card))" }} />
          </div>
        </main>
      </div>
    ...
    <div className="relative min-h-screen bg-background overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-[44px] pb-[200px] flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-2">
          <button
            className="w-full rounded-[3px] border-[2px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-between px-4 py-3 transition-colors hover:bg-card"
          ...
          {user?.email === "louisjridland@gmail.com" && (
            <button
              className="w-full rounded-[3px] border-[2px] border-[hsl(var(--border-mid))] bg-card flex items-center justify-center gap-2 px-4 py-3 text-xs font-[900] lowercase text-white transition-colors hover:bg-card"
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      <main className="relative z-[1] mx-auto w-full max-w-lg px-[24px] pt-[44px] pb-[140px] flex flex-col items-center">
        ...
        <div className="w-full p-5 space-y-3" style={{ borderRadius: 3, backgroundColor: "hsl(var(--card))", border: "2px solid hsl(var(--border-mid))" }}>
          <button
            ...
            style={{ background: "#ffffff", color: "#000000", borderRadius: 3, fontSize: 14, fontWeight: 900, textTransform: "lowercase", border: "none" }}
          >
            {googleLoading ? (
