  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="w-full max-w-lg mx-auto px-4 pt-12 pb-12">
        ...
        {success ? (
          <div className="border-[6px] border-border rounded-2xl p-6 text-center">
          ...
          <div className="border-[6px] border-border rounded-2xl p-4">
            <form onSubmit={handleSubmit} className="space-y-6">
              {error && (
                <div className="border-[6px] border-destructive/30 bg-destructive/5 p-3 text-destructive font-extrabold lowercase rounded-2xl text-xs">
                  {error}
                </div>
              )}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    minLength={6}
                    className="w-full border-[6px] border-border bg-background text-foreground pl-10 pr-4 py-3.5 text-xs font-extrabold lowercase placeholder:text-foreground/30 focus:outline-none focus:border-foreground rounded-2xl transition-colors"
                    placeholder="••••••••"
                  />
                </div>
              </div>
