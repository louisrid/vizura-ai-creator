...
const ResetPassword = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg md:max-w-2xl mx-auto px-[24px] md:px-[44px] pt-[44px] pb-[140px] md:flex md:flex-col md:items-center md:justify-center md:min-h-screen md:pt-0 md:pb-0">
        <div className="w-full md:max-w-md">
          ...
          {success ? (
            <div className="border-[2px] border-[hsl(var(--border-mid))] rounded-[5px] p-6 md:p-8 text-center">
            ...
            <div className="border-[2px] border-[hsl(var(--border-mid))] rounded-[5px] p-4 md:p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                {error && (
                  <div className="border-[2px] border-destructive/30 bg-destructive/5 p-3 text-destructive font-extrabold lowercase rounded-[5px] text-xs md:text-sm">
                    {error}
                  </div>
                )}
