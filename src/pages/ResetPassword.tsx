          ...
          {success ? (
            ...
            <div className="border-[1.5px] border-[hsl(var(--border-mid))] rounded-[8px] p-4 md:p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                {error && (
                  <div className="border-[1.5px] border-destructive bg-[#1a0808] p-3 text-destructive font-extrabold lowercase rounded-[8px] text-xs md:text-sm">
                    {error}
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      minLength={6}
                      className="w-full border-[1.5px] border-[hsl(var(--border-mid))] text-foreground pl-10 pr-4 py-3.5 text-2xl font-extrabold lowercase placeholder:text-muted-foreground focus:outline-none focus:border-neon-yellow transition-colors"
