    ...
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg md:max-w-2xl mx-auto px-[24px] md:px-[48px] pt-[34px] pb-[140px] md:flex md:flex-col md:items-center md:justify-center md:min-h-screen md:pt-0 md:pb-0">
        <div className="w-full md:max-w-md">
          ...
          {success ? (
            <div className="border-[3px] border-[hsl(var(--border-mid))] rounded-[8px] p-6 md:p-8 text-center">
            ...
            <div className="border-[3px] border-[hsl(var(--border-mid))] rounded-[8px] p-4 md:p-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      minLength={6}
                      className="w-full border-[3px] border-[hsl(var(--border-mid))] text-foreground pl-10 pr-4 py-3.5 text-2xl font-extrabold lowercase placeholder:text-white/60 focus:outline-none focus:border-neon-yellow transition-colors"
