...
const MyCharacters = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      {!loading && (
        <div className="fixed left-0 right-0 bottom-0 z-10 px-6" style={{ paddingBottom: "clamp(18px, calc((100vh - 100dvh) / 3 + 16px), 32px)", background: "linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.95) 25%, rgba(0,0,0,0.7) 50%, rgba(0,0,0,0.3) 70%, transparent 100%)", paddingTop: 48 }}>
