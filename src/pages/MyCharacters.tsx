  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      <DotDecal />
        ...
        <main className="relative z-[1] w-full max-w-lg md:max-w-5xl mx-auto px-[14px] md:px-10 pt-10 pb-[140px]">
                  ...
                  >
                    <AspectRatio ratio={3 / 4}>
                      {hasFace ? (
                        ...
                        <div className="flex h-full w-full items-center justify-center" style={{ backgroundColor: "#161616" }}>
