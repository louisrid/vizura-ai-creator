  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/95 px-4 pt-24 pb-6">
      <div className="relative w-full max-w-md md:max-w-lg">
        ...
        <div>
          <img src={photo.image_url} alt="" className="w-full rounded-[6px] object-contain max-h-[60vh]" onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} />
...
const AdminCharacterDetail = ({ character, onBack }: { character: any; onBack: () => void }) => {
  ...
  const imgSlot = (url: string | null | undefined, label: string) => (
    <div className="relative aspect-[3/4] w-full flex items-center justify-center" style={{ borderRadius: 6, backgroundColor: "#000000" }}>
      {isValidImg(url) ? (
    ...
    <>
      <div className="flex items-center gap-3 mb-2">
        <button
          ...
          style={{ width: 40, height: 40, borderRadius: 6, backgroundColor: "#ffe603" }}
        >
      ...
      <div className="flex flex-col gap-3 max-w-lg">
        ...
        <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 6 }} className="px-4 py-3">
        ...
        {expanded && (
          ...
          >
            ...
            >
              ...
              <div className="overflow-hidden" style={{ backgroundColor: "hsl(var(--card))", borderRadius: 6, border: "2px solid hsl(var(--border-mid))" }}>
                    ...
                    {photos.length > 0 ? (
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2.5 md:gap-4">
                        {photos.map((p: any, i: number) => {
                          ...
                          return (
                            <button key={i} onClick={() => setSelectedPhoto(p)} className="text-left hover-lift" style={{ borderRadius: 6, backgroundColor: "hsl(var(--card))", overflow: "hidden" }}>
