          ...
          <div className="mt-4 space-y-2">
            {showPromptButton ? (
              <button
                ...
                className="w-full flex items-start gap-2 px-3 py-2.5 border-[2.5px] border-[hsl(var(--border-mid))] text-[10px] md:text-[12px] font-[800] lowercase text-white text-left rounded-[8px]"
        ...
        {expanded && (
          ...
          >
            ...
            >
              ...
              <div className="overflow-hidden" style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8, border: "2.5px solid hsl(var(--border-mid))" }}>
        ...
        {confirmReset && (
          ...
          >
            <motion.div
              ...
              style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8, border: "2.5px solid hsl(var(--border-mid))" }}
            >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  style={{ color: "#ffffff", borderRadius: 8, border: "2.5px solid hsl(var(--border-mid))", backgroundColor: "transparent" }}
                >
                  cancel
                </button>
                <button
