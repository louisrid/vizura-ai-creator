    ...
    <>
      <div className="flex items-center gap-3 mb-2">
        <button
          ...
          style={{ width: 40, height: 40, borderRadius: 2, backgroundColor: "#dddddd" }}
        >
...
const UserStorageView = ({ userId, onBack, onReset }: { userId: string; onBack: () => void; onReset: () => void }) => {
  ...
  return (
    <>
      ...
      <p className="text-[13px] font-extrabold lowercase mb-3" style={{ color: "#dddddd" }}>{email}</p>
      <button
                  ...
                  <div className="grid grid-cols-3 gap-2.5 md:gap-4 mb-8">
                    {[
                      ...
                      <div key={label} className="flex flex-col items-center justify-center py-4 md:py-6" style={{ borderRadius: 2, backgroundColor: "hsl(var(--card))" }}>
                        <Icon size={16} strokeWidth={2.5} style={{ color: "#dddddd" }} className="mb-1 md:w-5 md:h-5" />
                            ...
                            <button key={i} onClick={() => setSelectedPhoto(p)} className="text-left hover-lift" style={{ borderRadius: 2, backgroundColor: "hsl(var(--card))", overflow: "hidden" }}>
                              ...
                              <div className="px-3 py-2.5 space-y-1">
                                ...
                                <div className="flex items-center gap-1.5">
                                  ...
                                  {p.character_name && (
                                    <span className="text-[9px] md:text-[10px] font-extrabold lowercase shrink-0" style={{ color: "#dddddd" }}>· {p.character_name}</span>
                                  )}
                                </div>
                              </div>
                            </button>
