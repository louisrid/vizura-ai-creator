          ...
          <div className="mt-4 space-y-2">
            {showPromptButton ? (
              <button
                ...
                className="w-full flex items-start gap-2 px-3 py-2.5 border-[1.5px] border-[hsl(var(--border-mid))] text-[10px] md:text-[12px] font-[800] lowercase text-white text-left rounded-[8px]"
  ...
  return (
    <>
      ...
      <button
        ...
        style={{ padding: "12px 0", color: "#ff4444", borderRadius: 8, border: "1.5px solid #ff4444", backgroundColor: "transparent" }}
      >
        reset user
      </button>
                ...
                {images.map((img) => (
                  <div key={img.id} className="flex flex-col hover-lift">
                    <button
                      ...
                      className="group relative rounded-t-[6px] border-[1.5px] border-b-0 border-[hsl(var(--border-mid))] overflow-hidden bg-card transition-all hover:border-foreground/60 text-left"
                    >
                      <AspectRatio ratio={3 / 4}>
        ...
        {expanded && (
          ...
          >
            ...
            >
              ...
              <div className="overflow-hidden" style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8, border: "1.5px solid hsl(var(--border-mid))" }}>
        ...
        {confirmReset && (
          ...
          >
            <motion.div
              ...
              style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8, border: "1.5px solid hsl(var(--border-mid))" }}
            >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  style={{ color: "#ffffff", borderRadius: 8, border: "1.5px solid hsl(var(--border-mid))", backgroundColor: "transparent" }}
                >
                  cancel
                </button>
                <button
                  ...
                  style={{ color: "#ffffff", borderRadius: 8, backgroundColor: "#ff4444", border: "1.5px solid #ff4444" }}
                >
